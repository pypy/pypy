...
from pyrepl.readline import ReadlineAlikeReader, ReadlineConfig, _ReadlineWrapper
from pyrepl.readline import multiline_input as readline_multiline_input
...
class TestPyReplOutput(TestCase):
    ...
    def test_control_character1(self):
...
class TestPyReplCompleter(TestCase):
    ...
    @skipIf(is_pypy, reason="too complicated")
    ...
    @patch("pyrepl.readline._ReadlineWrapper.get_reader")
...
class TestMain(ReplTestCase):
    ...
    @force_not_colorized
    @skipIf(is_pypy, reason="tracebacklimit works differently on PyPy")
    ...
    @skipIf(is_pypy, reason="no backend in PyPy readline")
