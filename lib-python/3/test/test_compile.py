...
if 1:
    ...
    def test_literals_with_leading_zeroes(self):
        ...
        self.assertEqual(eval("0777."), 777.0)
        self.assertEqual(eval("0777.0"), 777.0)
        self.assertEqual(eval("000000000000000000000000000000000000000000000000000777e0"), 777.0)
        self.assertEqual(eval("0777e1"), 7770.0)
