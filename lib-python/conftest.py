...
testmap = [
    ...
    RegrTest('test__xxinterpchannels.py', skip="implementation detail"),
    RegrTest('test__xxsubinterpreters.py', skip="implementation detail"),
    ...
    RegrTest('test_compiler_assemble.py'),
    RegrTest('test_compiler_codegen.py'),
    ...
    RegrTest('test_math_property.py'),
    ...
    RegrTest('test_perf_profiler.py'),
    RegrTest('test_perfmaps.py'),
    ...
    RegrTest('test_tix.py', skip="needs display"),
    ...
    RegrTest('test_ctypes'),
    RegrTest('test_concurrent_futures'),
    RegrTest('test_cext'),
    RegrTest('test_cppext'),
    RegrTest('test_dataclasses'),
    RegrTest('test_doctest'),
    RegrTest('test_except_star.py'),
    RegrTest('test_exception_group.py'),
    ...
    RegrTest('test_lib2to3'),
    RegrTest('test_module'),
    RegrTest('test_multiprocessing_fork'),
    RegrTest('test_multiprocessing_forkserver'),
    ...
    RegrTest('test_ttk', skip="needs display"),
    RegrTest('test_tkinter', skip="needs display"),
    RegrTest('test_unittest'),
    RegrTest('test_zipfile'),
