...
"""
from rpython.tool.singledispatch.singledispatch import singledispatch
...
@singledispatch
def install_marshaller(obj):
    raise NotImplementedError


@singledispatch
def install_unmarshaller(obj):
    raise NotImplementedError


@install_marshaller.register(annmodel.SomeObject)
def _(s_obj):
...
@install_unmarshaller.register(annmodel.SomeObject)
def _(s_obj):
    if not hasattr(s_obj, '_get_rmarshall_support_'):
        raise CannotUnmarshall(s_obj)
...
@install_marshaller.register(annmodel.SomeList)
def _(s_list):
...
@install_unmarshaller.register(annmodel.SomeList)
def _(s_list):
...
@install_marshaller.register(annmodel.SomeDict)
def _(s_dict):
...
@install_unmarshaller.register(annmodel.SomeDict)
def _(s_dict):
...
@install_marshaller.register(annmodel.SomeTuple)
def _(s_tuple):
...
@install_unmarshaller.register(annmodel.SomeTuple)
def _(s_tuple):
