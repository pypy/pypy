from rpython.translator.cli.metavm import  Call, CallMethod, \
     ...
     DebugPrint, UnboxInt
from rpython.translator.oosupport.metavm import PushArg, PushAllArgs, StoreResult, InstructionList,\
