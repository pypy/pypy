...
from rpython.rlib.test.test_rarithmetic import Test_r_uint as BaseTest_r_uint
from rpython.rlib.test.test_rarithmetic import Test_r_int as BaseTest_r_int
from rpython.rlib.test.test_rarithmetic import test_ovfcheck as base_test_ovfcheck
