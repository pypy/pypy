...
class TestOptimizeIntBounds(BaseTestBasic):
    def teardown_class(cls):
        if cls is not TestOptimizeIntBounds:
            return
        # the coverage check below only makes sense if the whole class ran;
        # skip it when the test run was filtered with -k/-m, since then most
        # rules won't have fired and that's expected, not a bug
    ...
    def test_rule_sub_sub_right_c_c_x(self):
        ops = """
        [i0]
        i1 = int_sub(10, i0)
        i2 = int_sub(20, i1)
