...
class OptIntAutoGenerated(object):
    ...
    def optimize_INT_XOR(self, op):
        ...
        if b_arg_0.known_eq_const(-1):
            ...
            return
        return self.emit(op)
    _rule_names_int_lshift = ['lshift_zero_x', 'lshift_x_zero']
    _rule_fired_int_lshift = [0] * 2
    ...
    def optimize_INT_LSHIFT(self, op):
        ...
        if b_arg_1.known_eq_const(0):
            ...
            return
        return self.emit(op)
    _rule_names_int_rshift = ['rshift_zero_x', 'rshift_known_result']
    _rule_fired_int_rshift = [0] * 2
