...
class OptIntAutoGenerated(object):
    ...
    def optimize_INT_ADD(self, op):
        ...
        if arg_1_int_neg is not None:
            ...
            return
        return self.emit(op)
    _rule_names_int_sub = ['sub_zero', 'sub_const_canonicalize', 'sub_from_zero', 'sub_x_x', 'sub_add', 'sub_add_neg', 'sub_sub_right_c_c_x', 'sub_xor_x_y_y', 'sub_or_x_y_y', 'sub_invert_one']
    _rule_fired_int_sub = [0] * 10
