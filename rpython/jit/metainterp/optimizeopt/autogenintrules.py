...
class OptIntAutoGenerated(object):
    def _eq(self, box1, bound1, box2, bound2):
        ...
        return False
    _all_rules_fired = []
    _rule_names_int_add = ['add_reassoc_consts', 'add_zero', 'add_sub_x_c_c', 'add_sub_c_x_c', 'add_const_fold', 'sub_add_cancel_right', 'add_neg_to_sub']
    _rule_fired_int_add = [0] * 7
    ...
    def optimize_INT_ADD(self, op):
        ...
        if b_arg_0.is_constant():
            ...
            if b_arg_1.is_constant():
                ...
                # add_const_fold: int_add(C1, C2) => C
                C = intmask(r_uint(C_arg_0) + r_uint(C_arg_1))
                self.make_equal_to(op, ConstInt(C))
                self._rule_fired_int_add[4] += 1
                return
                # add_const_fold: int_add(C2, C1) => C
                C = intmask(r_uint(C_arg_1) + r_uint(C_arg_0))
                self.make_equal_to(op, ConstInt(C))
                self._rule_fired_int_add[4] += 1
                return
        if b_arg_0.is_constant():
        ...
        if arg_1_int_neg is not None:
            ...
            return
        return self.emit(op)
    _rule_names_int_sub = ['sub_zero', 'sub_from_zero', 'sub_x_x', 'sub_add_consts', 'sub_add', 'sub_add_neg', 'sub_sub_left_x_c_c', 'sub_sub_left_c_x_c', 'sub_xor_x_y_y', 'sub_or_x_y_y', 'sub_invert_one', 'sub_flags_irrelevant']
    ...
    def optimize_INT_SUB(self, op):
        ...
        if b_arg_0.is_constant():
            ...
            if b_arg_1.is_constant():
                C_arg_1 = b_arg_1.get_constant_int()
                # sub_flags_irrelevant: int_sub(C2, C1) => C
                C = intmask(r_uint(C_arg_0) - r_uint(C_arg_1))
                self.make_equal_to(op, ConstInt(C))
        ...
        if arg_1_int_add is not None:
            ...
            if self._eq(arg_1_0, b_arg_1_0, arg_0, b_arg_0):
                ...
                return
        return self.emit(op)
    _rule_names_int_mul = ['mul_zero', 'mul_one', 'mul_minus_one', 'mul_pow2_const', 'mul_lshift', 'mul_nsw_flag_irrelevant', 'mul_reassociate_const']
    ...
    def optimize_INT_MUL(self, op):
        ...
        if b_arg_0.is_constant():
            ...
            if b_arg_1.is_constant():
                C_arg_1 = b_arg_1.get_constant_int()
                # mul_nsw_flag_irrelevant: int_mul(C1, C2) => C
                C = intmask(r_uint(C_arg_0) * r_uint(C_arg_1))
                self.make_equal_to(op, ConstInt(C))
                self._rule_fired_int_mul[5] += 1
                return
                # mul_nsw_flag_irrelevant: int_mul(C2, C1) => C
                C = intmask(r_uint(C_arg_1) * r_uint(C_arg_0))
                self.make_equal_to(op, ConstInt(C))
                self._rule_fired_int_mul[5] += 1
                return
                ...
                if b_arg_1_0.is_constant():
                    ...
                    if C_arg_1_0 == 1:
                        if b_arg_1_1.known_ge_const(0) and b_arg_1_1.known_le_const(LONG_BIT):
                            ...
                            return
        return self.emit(op)
    _rule_names_int_and = ['and_x_x', 'and_reassoc_consts', 'and_x_c_in_range', 'and_idempotent', 'and_or', 'and_known_result', 'and_absorb']
        ...
        if arg_1_int_and is not None:
            ...
            if arg_1_int_or is not None:
                ...
                if b_arg_1_0.and_bound(b_arg_0).known_eq_const(0):
                    ...
                    return
        return self.emit(op)
    _rule_names_int_or = ['or_x_x', 'or_known_result', 'or_absorb', 'or_idempotent', 'or_and_two_parts', 'or_reassoc_consts', 'or_const_const']
    ...
    def optimize_INT_OR(self, op):
        ...
        if b_arg_0.is_constant():
            ...
            if b_arg_1.is_constant():
                C_arg_1 = b_arg_1.get_constant_int()
                # or_const_const: int_or(C1, C2) => C
                C = C_arg_0 | C_arg_1
                self.make_equal_to(op, ConstInt(C))
                self._rule_fired_int_or[6] += 1
                return
                # or_const_const: int_or(C2, C1) => C
                C = C_arg_1 | C_arg_0
                self.make_equal_to(op, ConstInt(C))
                self._rule_fired_int_or[6] += 1
                return
        ...
        if b_arg_1.is_constant():
            ...
            if C_arg_1 == 1:
                if b_arg_0.is_bool():
                    ...
                    return
        return self.emit(op)
    _rule_names_int_lshift = ['lshift_zero_x', 'lshift_x_zero', 'lshift_rshift_c_c', 'lshift_and_rshift', 'lshift_urshift_c_c', 'lshift_and_urshift', 'lshift_lshift_c_c', 'lsh_const_const']
    _rule_fired_int_lshift = [0] * 8
    ...
    def optimize_INT_LSHIFT(self, op):
        ...
        if b_arg_0.is_constant():
            ...
            if b_arg_1.is_constant():
                C_arg_1 = b_arg_1.get_constant_int()
                # lsh_const_const: int_lshift(C1, C2) => C
                C = C_arg_0 << C_arg_1
                self.make_equal_to(op, ConstInt(C))
                self._rule_fired_int_lshift[7] += 1
                return
            ...
            if b_arg_0_1.is_constant():
                ...
                if b_arg_1.is_constant():
                    ...
                    if C_arg_1 == C_arg_0_1:
                        ...
                        return
        return self.emit(op)
    _rule_names_int_eq = ['eq_different_knownbits', 'eq_same', 'eq_one', 'eq_zero', 'eq_sub_eq', 'add_const_eqv_cmp_shift', 'sub_compare_zero_eq_ne', 'bitxor_eq_zero', 'eq_sub_add_const_commute', 'add_eq_self_iff_zero']
    ...
    def optimize_INT_EQ(self, op):
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_sub is not None:
                ...
                if b_arg_1_1.is_constant():
                    C_arg_1_1 = b_arg_1_1.get_constant_int()
                    # eq_sub_add_const_commute: int_eq(C2, int_sub(x, C1)) => int_eq(x, C)
                    C = intmask(r_uint(C_arg_0) + r_uint(C_arg_1_1))
            ...
            if arg_0_int_sub is not None:
                ...
                if b_arg_0_1.is_constant():
                    ...
                    if b_arg_1.is_constant():
                        C_arg_1 = b_arg_1.get_constant_int()
                        # eq_sub_add_const_commute: int_eq(int_sub(x, C1), C2) => int_eq(x, C)
                        C = intmask(r_uint(C_arg_1) + r_uint(C_arg_0_1))
        ...
        if b_arg_1.is_constant():
            ...
            if arg_1_int_add is not None:
                ...
                if self._eq(arg_1_0, b_arg_1_0, arg_0, b_arg_0):
                    ...
                    return
        return self.emit(op)
    _rule_names_int_ne = ['ne_different_knownbits', 'ne_same', 'ne_zero', 'ne_add_sub_const_commute', 'ne_sub_add_const_commute', 'ne_add_cancel_left']
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_add is not None:
                ...
                if arg_1_int_sub is not None:
                    ...
                    if b_arg_1_1.is_constant():
                        C_arg_1_1 = b_arg_1_1.get_constant_int()
                        # ne_sub_add_const_commute: int_ne(C2, int_sub(x, C1)) => int_ne(x, C)
                        C = intmask(r_uint(C_arg_0) + r_uint(C_arg_1_1))
                        newop = self.replace_op_with(op, rop.INT_NE, args=[arg_1_0, ConstInt(C)])
                        self.optimizer.send_extra_operation(newop)
            ...
            if arg_0_int_add is not None:
                ...
                if arg_0_int_sub is not None:
                    ...
                    if b_arg_0_1.is_constant():
                        ...
                        if b_arg_1.is_constant():
                            C_arg_1 = b_arg_1.get_constant_int()
                            # ne_sub_add_const_commute: int_ne(int_sub(x, C1), C2) => int_ne(x, C)
                            C = intmask(r_uint(C_arg_1) + r_uint(C_arg_0_1))
                            newop = self.replace_op_with(op, rop.INT_NE, args=[arg_0_0, ConstInt(C)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_ne[4] += 1
