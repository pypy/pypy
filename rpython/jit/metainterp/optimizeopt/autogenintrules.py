...
class OptIntAutoGenerated(object):
    def _eq(self, box1, bound1, box2, bound2):
        ...
        return False
    _all_rules_fired = []
    _rule_names_int_add = ['add_reassoc_consts', 'add_zero', 'add_sub_c_x_c', 'sub_add_cancel_right', 'add_neg_to_sub', 'add_add_sub_cancel']
    _rule_fired_int_add = [0] * 6
    ...
    def optimize_INT_ADD(self, op):
        ...
        if b_arg_0.is_constant():
            ...
            if arg_0_int_sub is not None:
                ...
                # sub_add_cancel_right: int_add(int_sub(x, y), y) => x
        ...
        if b_arg_1.is_constant():
            ...
            if arg_1_int_sub is not None:
                ...
                # sub_add_cancel_right: int_add(y, int_sub(x, y)) => x
        ...
        if b_arg_0.is_constant():
            ...
            if arg_0_int_add is not None:
                ...
                if b_arg_0_0.is_constant():
                    ...
                    arg_0_0_int_sub = self.optimizer.as_operation(arg_0_0, rop.INT_SUB)
                    if arg_0_0_int_sub is not None:
                        arg_0_0_0 = get_box_replacement(arg_0_0_int_sub.getarg(0))
                        b_arg_0_0_0 = self.getintbound(arg_0_0_0)
                        arg_0_0_1 = get_box_replacement(arg_0_0_int_sub.getarg(1))
                        b_arg_0_0_1 = self.getintbound(arg_0_0_1)
                        # add_add_sub_cancel: int_add(int_add(int_sub(z, x), y), x) => int_add(y, z)
                        if self._eq(arg_1, b_arg_1, arg_0_0_1, b_arg_0_0_1):
                            newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_0_1, arg_0_0_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_add[5] += 1
                            return
                if b_arg_0_1.is_constant():
                    ...
                    arg_0_1_int_sub = self.optimizer.as_operation(arg_0_1, rop.INT_SUB)
                    if arg_0_1_int_sub is not None:
                        arg_0_1_0 = get_box_replacement(arg_0_1_int_sub.getarg(0))
                        b_arg_0_1_0 = self.getintbound(arg_0_1_0)
                        arg_0_1_1 = get_box_replacement(arg_0_1_int_sub.getarg(1))
                        b_arg_0_1_1 = self.getintbound(arg_0_1_1)
                        # add_add_sub_cancel: int_add(int_add(y, int_sub(z, x)), x) => int_add(y, z)
                        if self._eq(arg_1, b_arg_1, arg_0_1_1, b_arg_0_1_1):
                            newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_0_0, arg_0_1_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_add[5] += 1
                            return
            else:
                ...
                if arg_0_int_neg is not None:
                    ...
                    b_arg_0_0 = self.getintbound(arg_0_0)
                    # add_neg_to_sub: int_add(int_neg(y), x) => int_sub(x, y)
                    newop = self.replace_op_with(op, rop.INT_SUB, args=[arg_1, arg_0_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_add[4] += 1
                    return
                else:
                    arg_0_int_sub = self.optimizer.as_operation(arg_0, rop.INT_SUB)
                    if arg_0_int_sub is not None:
        ...
        if arg_1_int_add is not None:
            ...
            arg_1_1 = get_box_replacement(arg_1_int_add.getarg(1))
            b_arg_1_1 = self.getintbound(arg_1_1)
            arg_1_0_int_sub = self.optimizer.as_operation(arg_1_0, rop.INT_SUB)
            if arg_1_0_int_sub is not None:
                arg_1_0_0 = get_box_replacement(arg_1_0_int_sub.getarg(0))
                b_arg_1_0_0 = self.getintbound(arg_1_0_0)
                arg_1_0_1 = get_box_replacement(arg_1_0_int_sub.getarg(1))
                b_arg_1_0_1 = self.getintbound(arg_1_0_1)
                # add_add_sub_cancel: int_add(x, int_add(int_sub(z, x), y)) => int_add(y, z)
                if self._eq(arg_1_0_1, b_arg_1_0_1, arg_0, b_arg_0):
                    newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_1_1, arg_1_0_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_add[5] += 1
                    return
            arg_1_1_int_sub = self.optimizer.as_operation(arg_1_1, rop.INT_SUB)
            if arg_1_1_int_sub is not None:
                arg_1_1_0 = get_box_replacement(arg_1_1_int_sub.getarg(0))
                b_arg_1_1_0 = self.getintbound(arg_1_1_0)
                arg_1_1_1 = get_box_replacement(arg_1_1_int_sub.getarg(1))
                b_arg_1_1_1 = self.getintbound(arg_1_1_1)
                # add_add_sub_cancel: int_add(x, int_add(y, int_sub(z, x))) => int_add(y, z)
                if self._eq(arg_1_1_1, b_arg_1_1_1, arg_0, b_arg_0):
                    newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_1_0, arg_1_1_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_add[5] += 1
                    return
        else:
            arg_1_int_neg = self.optimizer.as_operation(arg_1, rop.INT_NEG)
            if arg_1_int_neg is not None:
                arg_1_0 = get_box_replacement(arg_1_int_neg.getarg(0))
                b_arg_1_0 = self.getintbound(arg_1_0)
                # add_neg_to_sub: int_add(x, int_neg(y)) => int_sub(x, y)
                newop = self.replace_op_with(op, rop.INT_SUB, args=[arg_0, arg_1_0])
                self.optimizer.send_extra_operation(newop)
                self._rule_fired_int_add[4] += 1
                return
        return self.emit(op)
    _rule_names_int_sub = ['sub_zero', 'sub_const_canonicalize', 'sub_from_zero', 'sub_x_x', 'sub_add', 'sub_add_neg', 'sub_sub_right_c_c_x', 'sub_xor_x_y_y', 'sub_or_x_y_y', 'sub_invert_one', 'sub_neg', 'sub_add_add_cancel', 'sub_add_consts', 'sub_add_const_cancel', 'sub_add_add_consts', 'sub_const_add', 'sub_add_minus_one_const']
    _rule_fired_int_sub = [0] * 17
    ...
    def optimize_INT_SUB(self, op):
        ...
        if arg_0_int_add is not None:
            ...
            if b_arg_0_0.is_constant():
                ...
                if arg_1_int_add is not None:
                    ...
                    if b_arg_1_0.is_constant():
                        C_arg_1_0 = b_arg_1_0.get_constant_int()
                        # sub_add_add_consts: int_sub(int_add(C1, x), int_add(C2, x)) => C
                        if self._eq(arg_1_1, b_arg_1_1, arg_0_1, b_arg_0_1):
                            C = intmask(r_uint(C_arg_0_0) - r_uint(C_arg_1_0))
                            self.make_equal_to(op, ConstInt(C))
                            self._rule_fired_int_sub[14] += 1
                            return
                    if b_arg_1_1.is_constant():
                        C_arg_1_1 = b_arg_1_1.get_constant_int()
                        # sub_add_add_consts: int_sub(int_add(C1, x), int_add(x, C2)) => C
                        if self._eq(arg_1_0, b_arg_1_0, arg_0_1, b_arg_0_1):
                            C = intmask(r_uint(C_arg_0_0) - r_uint(C_arg_1_1))
                            self.make_equal_to(op, ConstInt(C))
                            self._rule_fired_int_sub[14] += 1
                            return
            if b_arg_0_1.is_constant():
                ...
                if arg_1_int_add is not None:
                    ...
                    if b_arg_1_0.is_constant():
                        C_arg_1_0 = b_arg_1_0.get_constant_int()
                        # sub_add_add_consts: int_sub(int_add(x, C1), int_add(C2, x)) => C
                        if self._eq(arg_1_1, b_arg_1_1, arg_0_0, b_arg_0_0):
                            C = intmask(r_uint(C_arg_0_1) - r_uint(C_arg_1_0))
                            self.make_equal_to(op, ConstInt(C))
                            self._rule_fired_int_sub[14] += 1
                            return
                    if b_arg_1_1.is_constant():
                        C_arg_1_1 = b_arg_1_1.get_constant_int()
                        # sub_add_add_consts: int_sub(int_add(x, C1), int_add(x, C2)) => C
                        if self._eq(arg_1_0, b_arg_1_0, arg_0_0, b_arg_0_0):
                            C = intmask(r_uint(C_arg_0_1) - r_uint(C_arg_1_1))
                            self.make_equal_to(op, ConstInt(C))
                            self._rule_fired_int_sub[14] += 1
                            return
        arg_1_int_add = self.optimizer.as_operation(arg_1, rop.INT_ADD)
        if arg_1_int_add is not None:
            ...
            if b_arg_1_0.is_constant():
                C_arg_1_0 = b_arg_1_0.get_constant_int()
                # sub_add_const_cancel: int_sub(x, int_add(C1, x)) => C
                if self._eq(arg_1_1, b_arg_1_1, arg_0, b_arg_0):
                    C = intmask(r_uint(0) - r_uint(C_arg_1_0))
                    self.make_equal_to(op, ConstInt(C))
                    self._rule_fired_int_sub[13] += 1
                    return
            if b_arg_1_1.is_constant():
                C_arg_1_1 = b_arg_1_1.get_constant_int()
                # sub_add_const_cancel: int_sub(x, int_add(x, C1)) => C
                if self._eq(arg_1_0, b_arg_1_0, arg_0, b_arg_0):
                    C = intmask(r_uint(0) - r_uint(C_arg_1_1))
                    self.make_equal_to(op, ConstInt(C))
                    self._rule_fired_int_sub[13] += 1
                    return
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_add is not None:
                ...
                if b_arg_1_0.is_constant():
                    C_arg_1_0 = b_arg_1_0.get_constant_int()
                    # sub_const_add: int_sub(C2, int_add(C1, x)) => int_sub(C, x)
                    C = intmask(r_uint(C_arg_0) - r_uint(C_arg_1_0))
                    newop = self.replace_op_with(op, rop.INT_SUB, args=[ConstInt(C), arg_1_1])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_sub[15] += 1
                    return
                if b_arg_1_1.is_constant():
                    C_arg_1_1 = b_arg_1_1.get_constant_int()
                    # sub_const_add: int_sub(C2, int_add(x, C1)) => int_sub(C, x)
                    C = intmask(r_uint(C_arg_0) - r_uint(C_arg_1_1))
                    newop = self.replace_op_with(op, rop.INT_SUB, args=[ConstInt(C), arg_1_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_sub[15] += 1
                    return
            else:
                ...
                if arg_1_int_sub is not None:
                    ...
                    if b_arg_1_0.is_constant():
                        C_arg_1_0 = b_arg_1_0.get_constant_int()
                        # sub_sub_right_c_c_x: int_sub(C1, int_sub(C2, x)) => int_add(x, C)
                        C = intmask(r_uint(C_arg_0) - r_uint(C_arg_1_0))
                        newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_1_1, ConstInt(C)])
                        self.optimizer.send_extra_operation(newop)
            ...
            if arg_0_int_invert is not None:
                ...
                if arg_0_int_add is not None:
                    ...
                    if b_arg_0_0.is_constant():
                        ...
                        if b_arg_1.is_constant():
                            C_arg_1 = b_arg_1.get_constant_int()
                            # sub_add_minus_one_const: int_sub(int_add(-1, x), C1) => int_add(x, C)
                            if C_arg_0_0 == -1:
                                C = C_arg_1 ^ -1
                                newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_0_1, ConstInt(C)])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_sub[16] += 1
                                return
                            # sub_add_consts: int_sub(int_add(C1, x), C2) => int_add(x, C)
                            C = intmask(r_uint(C_arg_0_0) - r_uint(C_arg_1))
                            newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_0_1, ConstInt(C)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_sub[12] += 1
                            return
                    if b_arg_0_1.is_constant():
                        C_arg_0_1 = b_arg_0_1.get_constant_int()
                        if b_arg_1.is_constant():
                            C_arg_1 = b_arg_1.get_constant_int()
                            # sub_add_minus_one_const: int_sub(int_add(x, -1), C1) => int_add(x, C)
                            if C_arg_0_1 == -1:
                                C = C_arg_1 ^ -1
                                newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_0_0, ConstInt(C)])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_sub[16] += 1
                                return
                            # sub_add_consts: int_sub(int_add(x, C1), C2) => int_add(x, C)
                            C = intmask(r_uint(C_arg_0_1) - r_uint(C_arg_1))
                            newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_0_0, ConstInt(C)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_sub[12] += 1
                    ...
                    if arg_1_int_add is not None:
                        ...
                        arg_1_1 = get_box_replacement(arg_1_int_add.getarg(1))
                        b_arg_1_1 = self.getintbound(arg_1_1)
                        # sub_add_add_cancel: int_sub(int_add(x, z), int_add(y, z)) => int_sub(x, y)
                        if self._eq(arg_1_1, b_arg_1_1, arg_0_1, b_arg_0_1):
                            newop = self.replace_op_with(op, rop.INT_SUB, args=[arg_0_0, arg_1_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_sub[11] += 1
                            return
                        # sub_add_add_cancel: int_sub(int_add(x, z), int_add(z, y)) => int_sub(x, y)
                        if self._eq(arg_1_0, b_arg_1_0, arg_0_1, b_arg_0_1):
                            newop = self.replace_op_with(op, rop.INT_SUB, args=[arg_0_0, arg_1_1])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_sub[11] += 1
                            return
                        # sub_add_add_cancel: int_sub(int_add(z, x), int_add(y, z)) => int_sub(x, y)
                        if self._eq(arg_1_1, b_arg_1_1, arg_0_0, b_arg_0_0):
                            newop = self.replace_op_with(op, rop.INT_SUB, args=[arg_0_1, arg_1_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_sub[11] += 1
                            return
                        # sub_add_add_cancel: int_sub(int_add(z, x), int_add(z, y)) => int_sub(x, y)
                        if self._eq(arg_1_0, b_arg_1_0, arg_0_0, b_arg_0_0):
                            newop = self.replace_op_with(op, rop.INT_SUB, args=[arg_0_1, arg_1_1])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_sub[11] += 1
                            return
        if b_arg_1.is_constant():
            C_arg_1 = b_arg_1.get_constant_int()
            # sub_const_canonicalize: int_sub(x, C1) => int_add(x, C)
            C = intmask(-r_uint(C_arg_1))
            newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_0, ConstInt(C)])
            self.optimizer.send_extra_operation(newop)
            ...
            if arg_1_int_add is not None:
                ...
                if arg_1_int_neg is not None:
                    arg_1_0 = get_box_replacement(arg_1_int_neg.getarg(0))
                    b_arg_1_0 = self.getintbound(arg_1_0)
                    # sub_neg: int_sub(x, int_neg(y)) => int_add(x, y)
                    newop = self.replace_op_with(op, rop.INT_ADD, args=[arg_0, arg_1_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_sub[10] += 1
                    return
        return self.emit(op)
    _rule_names_int_mul = ['mul_zero', 'mul_one', 'mul_minus_one', 'mul_pow2_const', 'mul_lshift', 'mul_reassociate_const']
    ...
    def optimize_INT_MUL(self, op):
        ...
        if b_arg_0.is_constant():
            C_arg_0 = b_arg_0.get_constant_int()
            arg_1_int_mul = self.optimizer.as_operation(arg_1, rop.INT_MUL)
            if arg_1_int_mul is not None:
                arg_1_0 = get_box_replacement(arg_1_int_mul.getarg(0))
                b_arg_1_0 = self.getintbound(arg_1_0)
                arg_1_1 = get_box_replacement(arg_1_int_mul.getarg(1))
                b_arg_1_1 = self.getintbound(arg_1_1)
                if b_arg_1_0.is_constant():
                    C_arg_1_0 = b_arg_1_0.get_constant_int()
                    # mul_reassociate_const: int_mul(C2, int_mul(C1, z)) => int_mul(C, z)
                    C = intmask(r_uint(C_arg_1_0) * r_uint(C_arg_0))
                    newop = self.replace_op_with(op, rop.INT_MUL, args=[ConstInt(C), arg_1_1])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_mul[5] += 1
                    return
                if b_arg_1_1.is_constant():
                    C_arg_1_1 = b_arg_1_1.get_constant_int()
                    # mul_reassociate_const: int_mul(C2, int_mul(z, C1)) => int_mul(C, z)
                    C = intmask(r_uint(C_arg_1_1) * r_uint(C_arg_0))
                    newop = self.replace_op_with(op, rop.INT_MUL, args=[ConstInt(C), arg_1_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_mul[5] += 1
                    return
            ...
            if arg_0_int_lshift is not None:
                ...
                arg_0_int_mul = self.optimizer.as_operation(arg_0, rop.INT_MUL)
                if arg_0_int_mul is not None:
                    arg_0_0 = get_box_replacement(arg_0_int_mul.getarg(0))
                    b_arg_0_0 = self.getintbound(arg_0_0)
                    arg_0_1 = get_box_replacement(arg_0_int_mul.getarg(1))
                    b_arg_0_1 = self.getintbound(arg_0_1)
                    if b_arg_0_0.is_constant():
                        C_arg_0_0 = b_arg_0_0.get_constant_int()
                        if b_arg_1.is_constant():
                            C_arg_1 = b_arg_1.get_constant_int()
                            # mul_reassociate_const: int_mul(int_mul(C1, z), C2) => int_mul(C, z)
                            C = intmask(r_uint(C_arg_0_0) * r_uint(C_arg_1))
                            newop = self.replace_op_with(op, rop.INT_MUL, args=[ConstInt(C), arg_0_1])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_mul[5] += 1
                            return
                    if b_arg_0_1.is_constant():
                        ...
                        if b_arg_1.is_constant():
                            C_arg_1 = b_arg_1.get_constant_int()
                            # mul_reassociate_const: int_mul(int_mul(z, C1), C2) => int_mul(C, z)
                            C = intmask(r_uint(C_arg_0_1) * r_uint(C_arg_1))
                            newop = self.replace_op_with(op, rop.INT_MUL, args=[ConstInt(C), arg_0_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_mul[5] += 1
                            return
        if b_arg_1.is_constant():
                ...
                if b_arg_1_0.is_constant():
                    ...
                    if C_arg_1_0 == 1:
                        if b_arg_1_1.known_ge_const(0) and b_arg_1_1.known_le_const(LONG_BIT):
                            ...
                            return
        return self.emit(op)
    _rule_names_int_and = ['and_x_x', 'and_reassoc_consts', 'and_x_c_in_range', 'and_idempotent', 'and_or', 'and_known_result', 'and_absorb', 'and_or_absorb']
    ...
    def optimize_INT_AND(self, op):
        ...
        if b_arg_0.is_constant():
            ...
            if arg_0_int_or is not None:
                ...
                arg_0_1 = get_box_replacement(arg_0_int_or.getarg(1))
                b_arg_0_1 = self.getintbound(arg_0_1)
                # and_or_absorb: int_and(int_or(x, y), x) => x
                if self._eq(arg_1, b_arg_1, arg_0_0, b_arg_0_0):
                    self.make_equal_to(op, arg_0_0)
                    self._rule_fired_int_and[7] += 1
                    return
                # and_or_absorb: int_and(int_or(y, x), x) => x
                if self._eq(arg_1, b_arg_1, arg_0_1, b_arg_0_1):
                    self.make_equal_to(op, arg_0_1)
                    self._rule_fired_int_and[7] += 1
                    return
        if b_arg_1.is_constant():
            ...
            if arg_1_int_or is not None:
                ...
                b_arg_1_1 = self.getintbound(arg_1_1)
                # and_or_absorb: int_and(x, int_or(x, y)) => x
                if self._eq(arg_1_0, b_arg_1_0, arg_0, b_arg_0):
                    self.make_equal_to(op, arg_0)
                    self._rule_fired_int_and[7] += 1
                    return
                # and_or_absorb: int_and(x, int_or(y, x)) => x
                if self._eq(arg_1_1, b_arg_1_1, arg_0, b_arg_0):
                    self.make_equal_to(op, arg_0)
                    self._rule_fired_int_and[7] += 1
                    return
        ...
        if b_arg_0.is_constant():
            ...
            if arg_0_int_and is not None:
                ...
                if arg_0_int_or is not None:
                    ...
                    if b_arg_0_1.and_bound(b_arg_1).known_eq_const(0):
                        newop = self.replace_op_with(op, rop.INT_AND, args=[arg_0_0, arg_1])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_and[4] += 1
                        return
                    # and_or: int_and(int_or(y, x), z) => int_and(x, z)
                    if b_arg_0_0.and_bound(b_arg_1).known_eq_const(0):
                        newop = self.replace_op_with(op, rop.INT_AND, args=[arg_0_1, arg_1])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_and[4] += 1
                        return
        arg_1_int_and = self.optimizer.as_operation(arg_1, rop.INT_AND)
        if arg_1_int_and is not None:
            ...
            if arg_1_int_or is not None:
                ...
                if b_arg_1_1.and_bound(b_arg_0).known_eq_const(0):
                    newop = self.replace_op_with(op, rop.INT_AND, args=[arg_1_0, arg_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_and[4] += 1
                    return
                # and_or: int_and(z, int_or(y, x)) => int_and(x, z)
                if b_arg_1_0.and_bound(b_arg_0).known_eq_const(0):
                    newop = self.replace_op_with(op, rop.INT_AND, args=[arg_1_1, arg_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_and[4] += 1
                    return
        return self.emit(op)
    _rule_names_int_or = ['or_x_x', 'or_known_result', 'or_absorb', 'or_and_absorb', 'or_idempotent', 'or_and_two_parts', 'or_reassoc_consts']
    _rule_fired_int_or = [0] * 7
    ...
    def optimize_INT_OR(self, op):
        ...
        if arg_0_int_and is not None:
            ...
            arg_0_1 = get_box_replacement(arg_0_int_and.getarg(1))
            b_arg_0_1 = self.getintbound(arg_0_1)
            # or_and_absorb: int_or(int_and(x, y), x) => x
            if self._eq(arg_1, b_arg_1, arg_0_0, b_arg_0_0):
                self.make_equal_to(op, arg_0_0)
                self._rule_fired_int_or[3] += 1
                return
            # or_and_absorb: int_or(int_and(y, x), x) => x
            if self._eq(arg_1, b_arg_1, arg_0_1, b_arg_0_1):
                self.make_equal_to(op, arg_0_1)
                self._rule_fired_int_or[3] += 1
                return
        ...
        if arg_1_int_and is not None:
            ...
            arg_1_1 = get_box_replacement(arg_1_int_and.getarg(1))
            b_arg_1_1 = self.getintbound(arg_1_1)
            # or_and_absorb: int_or(x, int_and(x, y)) => x
            if self._eq(arg_1_0, b_arg_1_0, arg_0, b_arg_0):
                self.make_equal_to(op, arg_0)
                self._rule_fired_int_or[3] += 1
                return
            # or_and_absorb: int_or(x, int_and(y, x)) => x
            if self._eq(arg_1_1, b_arg_1_1, arg_0, b_arg_0):
                self.make_equal_to(op, arg_0)
                self._rule_fired_int_or[3] += 1
                return
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_or is not None:
                ...
                if b_arg_1_0.is_constant():
                    ...
                    C = C_arg_1_0 | C_arg_0
                    newop = self.replace_op_with(op, rop.INT_OR, args=[arg_1_1, ConstInt(C)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_or[6] += 1
                    return
                if b_arg_1_1.is_constant():
                    C_arg_1_1 = b_arg_1_1.get_constant_int()
                    # or_reassoc_consts: int_or(C2, int_or(x, C1)) => int_or(x, C)
                    C = C_arg_1_1 | C_arg_0
                    newop = self.replace_op_with(op, rop.INT_OR, args=[arg_1_0, ConstInt(C)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_or[6] += 1
                    return
        else:
                ...
                if arg_0_int_or is not None:
                    ...
                    if b_arg_0_0.is_constant():
                        ...
                        if b_arg_1.is_constant():
                            ...
                            C = C_arg_0_0 | C_arg_1
                            newop = self.replace_op_with(op, rop.INT_OR, args=[arg_0_1, ConstInt(C)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_or[6] += 1
                            return
                    if b_arg_0_1.is_constant():
                        ...
                        if b_arg_1.is_constant():
                            ...
                            C = C_arg_0_1 | C_arg_1
                            newop = self.replace_op_with(op, rop.INT_OR, args=[arg_0_0, ConstInt(C)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_or[6] += 1
                            return
        ...
        if arg_1_int_or is not None:
            ...
            if self._eq(arg_1_1, b_arg_1_1, arg_0, b_arg_0):
                ...
                return
        return self.emit(op)
    _rule_names_int_xor = ['xor_x_x', 'xor_reassoc_consts', 'xor_absorb', 'xor_zero', 'xor_minus_1', 'xor_known_result', 'xor_is_not']
    _rule_fired_int_xor = [0] * 7
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_xor is not None:
                ...
                if b_arg_1_0.is_constant():
                    ...
                    C = C_arg_1_0 ^ C_arg_0
                    newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_1_1, ConstInt(C)])
                    self.optimizer.send_extra_operation(newop)
                ...
                if b_arg_1_1.is_constant():
                    ...
                    C = C_arg_1_1 ^ C_arg_0
                    newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_1_0, ConstInt(C)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_xor[1] += 1
                    return
            ...
            if arg_0_int_xor is not None:
                ...
                if b_arg_0_0.is_constant():
                    ...
                    if b_arg_1.is_constant():
                        ...
                        C = C_arg_0_0 ^ C_arg_1
                        newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_0_1, ConstInt(C)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_xor[1] += 1
                        return
                if b_arg_0_1.is_constant():
                    ...
                    if b_arg_1.is_constant():
                        ...
                        C = C_arg_0_1 ^ C_arg_1
                        newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_0_0, ConstInt(C)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_xor[1] += 1
                        return
        if b_arg_1.is_constant():
                            ...
                            if b_arg_1.is_constant():
                                ...
                                if C_arg_1 == C_arg_0_1:
                                    if 0 <= C_arg_0_1 and C_arg_0_1 < LONG_BIT:
                                        ...
                                        return
        return self.emit(op)
    _rule_names_int_rshift = ['rshift_zero_x', 'rshift_x_zero', 'rshift_known_result', 'rshift_lshift', 'rshift_rshift_c_c', 'rshift_minus_one']
    _rule_fired_int_rshift = [0] * 6
    ...
    def optimize_INT_RSHIFT(self, op):
        ...
        if b_arg_0.is_constant():
            C_arg_0 = b_arg_0.get_constant_int()
            # rshift_minus_one: int_rshift(-1, x) => -1
            if C_arg_0 == -1:
                self.make_constant_int(op, -1)
                self._rule_fired_int_rshift[5] += 1
                return
            ...
            if b_arg_0_1.is_constant():
                ...
                if b_arg_1.is_constant():
                    ...
                    if C_arg_1 == C_arg_0_1:
                        ...
                        return
        return self.emit(op)
    _rule_names_int_eq = ['eq_different_knownbits', 'eq_same', 'eq_one', 'eq_zero', 'eq_sub_eq', 'add_const_eqv_cmp_shift', 'sub_compare_zero_eq_ne', 'bitxor_eq_zero', 'add_eq_self_iff_zero', 'eq_add_add_cancel', 'eq_add_commute', 'eq_xor_cancel', 'eq_sub_consts', 'eq_sub_sub_cancel']
    _rule_fired_int_eq = [0] * 14
    ...
    def optimize_INT_EQ(self, op):
        ...
        if arg_0_int_add is not None:
            ...
            if arg_1_int_add is not None:
                ...
                arg_1_1 = get_box_replacement(arg_1_int_add.getarg(1))
                b_arg_1_1 = self.getintbound(arg_1_1)
                # eq_add_commute: int_eq(int_add(x, y), int_add(y, x)) => 1
                if self._eq(arg_1_0, b_arg_1_0, arg_0_1, b_arg_0_1):
                    if self._eq(arg_1_1, b_arg_1_1, arg_0_0, b_arg_0_0):
                        self.make_constant_int(op, 1)
                        self._rule_fired_int_eq[10] += 1
                        return
                # eq_add_commute: int_eq(int_add(y, x), int_add(x, y)) => 1
                if self._eq(arg_1_0, b_arg_1_0, arg_0_1, b_arg_0_1):
                    if self._eq(arg_1_1, b_arg_1_1, arg_0_0, b_arg_0_0):
                        self.make_constant_int(op, 1)
                        self._rule_fired_int_eq[10] += 1
                        return
                # eq_add_commute: int_eq(int_add(x, y), int_add(x, y)) => 1
                if self._eq(arg_1_0, b_arg_1_0, arg_0_0, b_arg_0_0):
                    if self._eq(arg_1_1, b_arg_1_1, arg_0_1, b_arg_0_1):
                        self.make_constant_int(op, 1)
                        self._rule_fired_int_eq[10] += 1
                        return
                # eq_add_commute: int_eq(int_add(y, x), int_add(y, x)) => 1
                if self._eq(arg_1_0, b_arg_1_0, arg_0_0, b_arg_0_0):
                    if self._eq(arg_1_1, b_arg_1_1, arg_0_1, b_arg_0_1):
                        self.make_constant_int(op, 1)
                        self._rule_fired_int_eq[10] += 1
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_sub is not None:
                ...
                if b_arg_1_0.is_constant():
                    C_arg_1_0 = b_arg_1_0.get_constant_int()
                    # eq_sub_consts: int_eq(C2, int_sub(C1, x)) => int_eq(x, C)
                    C = intmask(r_uint(C_arg_1_0) - r_uint(C_arg_0))
                    newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_1, ConstInt(C)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_eq[12] += 1
                    return
                # sub_compare_zero_eq_ne: int_eq(0, int_sub(x, y)) => int_eq(x, y)
                if C_arg_0 == 0:
                    newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_0, arg_1_1])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_eq[6] += 1
                    return
            else:
                arg_1_int_xor = self.optimizer.as_operation(arg_1, rop.INT_XOR)
                if arg_1_int_xor is not None:
                    ...
                    arg_1_1 = get_box_replacement(arg_1_int_xor.getarg(1))
                    b_arg_1_1 = self.getintbound(arg_1_1)
                    # bitxor_eq_zero: int_eq(0, int_xor(x, y)) => int_eq(x, y)
                    if C_arg_0 == 0:
                        newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_0, arg_1_1])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_eq[7] += 1
                        return
                    # bitxor_eq_zero: int_eq(0, int_xor(y, x)) => int_eq(x, y)
                    if C_arg_0 == 0:
                        newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_1, arg_1_0])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_eq[7] += 1
                        return
                else:
                    ...
                    if arg_1_int_add is not None:
                        ...
                        if b_arg_1_0.is_constant():
                            C_arg_1_0 = b_arg_1_0.get_constant_int()
                            # add_const_eqv_cmp_shift: int_eq(C2, int_add(C1, x)) => int_eq(x, C)
                            C = intmask(r_uint(C_arg_0) - r_uint(C_arg_1_0))
                            newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_1, ConstInt(C)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_eq[5] += 1
                            return
                        if b_arg_1_1.is_constant():
                            C_arg_1_1 = b_arg_1_1.get_constant_int()
                            # add_const_eqv_cmp_shift: int_eq(C2, int_add(x, C1)) => int_eq(x, C)
                            C = intmask(r_uint(C_arg_0) - r_uint(C_arg_1_1))
                            newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_0, ConstInt(C)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_eq[5] += 1
                            return
            ...
            if arg_0_int_sub is not None:
                ...
                if b_arg_0_0.is_constant():
                    ...
                    if b_arg_1.is_constant():
                        C_arg_1 = b_arg_1.get_constant_int()
                        # eq_sub_consts: int_eq(int_sub(C1, x), C2) => int_eq(x, C)
                        C = intmask(r_uint(C_arg_0_0) - r_uint(C_arg_1))
                        newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_1, ConstInt(C)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_eq[12] += 1
                        return
                if b_arg_1.is_constant():
                    C_arg_1 = b_arg_1.get_constant_int()
                    # sub_compare_zero_eq_ne: int_eq(int_sub(x, y), 0) => int_eq(x, y)
                    if C_arg_1 == 0:
                        newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_0, arg_0_1])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_eq[6] += 1
                        return
                else:
                    ...
                    if arg_1_int_sub is not None:
                        ...
                        arg_1_1 = get_box_replacement(arg_1_int_sub.getarg(1))
                        b_arg_1_1 = self.getintbound(arg_1_1)
                        # eq_sub_sub_cancel: int_eq(int_sub(x, z), int_sub(y, z)) => int_eq(x, y)
                        if self._eq(arg_1_1, b_arg_1_1, arg_0_1, b_arg_0_1):
                            newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_0, arg_1_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_eq[13] += 1
                            return
                        # eq_sub_sub_cancel: int_eq(int_sub(y, z), int_sub(x, z)) => int_eq(x, y)
                        if self._eq(arg_1_1, b_arg_1_1, arg_0_1, b_arg_0_1):
                            newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_0, arg_0_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_eq[13] += 1
                            return
            else:
                ...
                if arg_0_int_xor is not None:
                    ...
                    if b_arg_1.is_constant():
                        C_arg_1 = b_arg_1.get_constant_int()
                        # bitxor_eq_zero: int_eq(int_xor(x, y), 0) => int_eq(x, y)
                        if C_arg_1 == 0:
                            newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_0, arg_0_1])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_eq[7] += 1
                            return
                        # bitxor_eq_zero: int_eq(int_xor(y, x), 0) => int_eq(x, y)
                        if C_arg_1 == 0:
                            newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_1, arg_0_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_eq[7] += 1
                            return
                    # eq_xor_cancel: int_eq(int_xor(x, y), x) => int_eq(y, 0)
                    if self._eq(arg_1, b_arg_1, arg_0_0, b_arg_0_0):
                        newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_1, ConstInt(0)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_eq[11] += 1
                        return
                    # eq_xor_cancel: int_eq(int_xor(y, x), x) => int_eq(y, 0)
                    if self._eq(arg_1, b_arg_1, arg_0_1, b_arg_0_1):
                        newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_0, ConstInt(0)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_eq[11] += 1
                        return
                else:
                    ...
                    if arg_0_int_add is not None:
                        ...
                        if b_arg_0_0.is_constant():
                            ...
                            if b_arg_1.is_constant():
                                C_arg_1 = b_arg_1.get_constant_int()
                                # add_const_eqv_cmp_shift: int_eq(int_add(C1, x), C2) => int_eq(x, C)
                        ...
                        if b_arg_0_1.is_constant():
                            ...
                            if b_arg_1.is_constant():
                                C_arg_1 = b_arg_1.get_constant_int()
                                # add_const_eqv_cmp_shift: int_eq(int_add(x, C1), C2) => int_eq(x, C)
                                C = intmask(r_uint(C_arg_1) - r_uint(C_arg_0_1))
                                newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_0, ConstInt(C)])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_eq[5] += 1
                                return
                        arg_1_int_add = self.optimizer.as_operation(arg_1, rop.INT_ADD)
                        if arg_1_int_add is not None:
                            ...
                            arg_1_1 = get_box_replacement(arg_1_int_add.getarg(1))
                            b_arg_1_1 = self.getintbound(arg_1_1)
                            # eq_add_add_cancel: int_eq(int_add(x, z), int_add(y, z)) => int_eq(x, y)
                            if self._eq(arg_1_1, b_arg_1_1, arg_0_1, b_arg_0_1):
                                newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_0, arg_1_0])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_eq[9] += 1
                                return
                            # eq_add_add_cancel: int_eq(int_add(y, z), int_add(x, z)) => int_eq(x, y)
                            if self._eq(arg_1_1, b_arg_1_1, arg_0_1, b_arg_0_1):
                                newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_0, arg_0_0])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_eq[9] += 1
                                return
                            # eq_add_add_cancel: int_eq(int_add(x, z), int_add(z, y)) => int_eq(x, y)
                            if self._eq(arg_1_0, b_arg_1_0, arg_0_1, b_arg_0_1):
                                newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_0, arg_1_1])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_eq[9] += 1
                                return
                            # eq_add_add_cancel: int_eq(int_add(z, y), int_add(x, z)) => int_eq(x, y)
                            if self._eq(arg_1_1, b_arg_1_1, arg_0_0, b_arg_0_0):
                                newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_0, arg_0_1])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_eq[9] += 1
                                return
                            # eq_add_add_cancel: int_eq(int_add(z, x), int_add(y, z)) => int_eq(x, y)
                            if self._eq(arg_1_1, b_arg_1_1, arg_0_0, b_arg_0_0):
                                newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_1, arg_1_0])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_eq[9] += 1
                                return
                            # eq_add_add_cancel: int_eq(int_add(y, z), int_add(z, x)) => int_eq(x, y)
                            if self._eq(arg_1_0, b_arg_1_0, arg_0_1, b_arg_0_1):
                                newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_1, arg_0_0])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_eq[9] += 1
                                return
                            # eq_add_add_cancel: int_eq(int_add(z, x), int_add(z, y)) => int_eq(x, y)
                            if self._eq(arg_1_0, b_arg_1_0, arg_0_0, b_arg_0_0):
                                newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_1, arg_1_1])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_eq[9] += 1
                                return
                            # eq_add_add_cancel: int_eq(int_add(z, y), int_add(z, x)) => int_eq(x, y)
                            if self._eq(arg_1_0, b_arg_1_0, arg_0_0, b_arg_0_0):
                                newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_1, arg_0_1])
                                self.optimizer.send_extra_operation(newop)
                                self._rule_fired_int_eq[9] += 1
                                return
                        # add_eq_self_iff_zero: int_eq(int_add(y, x), x) => int_eq(y, 0)
                        if self._eq(arg_1, b_arg_1, arg_0_1, b_arg_0_1):
                            newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_0, ConstInt(0)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_eq[8] += 1
                            return
                        # add_eq_self_iff_zero: int_eq(int_add(x, y), x) => int_eq(y, 0)
                        if self._eq(arg_1, b_arg_1, arg_0_0, b_arg_0_0):
                            newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_0_1, ConstInt(0)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_eq[8] += 1
        ...
        if b_arg_1.is_constant():
            ...
            if arg_1_int_add is not None:
                ...
                arg_1_1 = get_box_replacement(arg_1_int_add.getarg(1))
                b_arg_1_1 = self.getintbound(arg_1_1)
                # add_eq_self_iff_zero: int_eq(x, int_add(y, x)) => int_eq(y, 0)
                if self._eq(arg_1_1, b_arg_1_1, arg_0, b_arg_0):
                    newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_0, ConstInt(0)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_eq[8] += 1
                    return
                # add_eq_self_iff_zero: int_eq(x, int_add(x, y)) => int_eq(y, 0)
                if self._eq(arg_1_0, b_arg_1_0, arg_0, b_arg_0):
                    newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_1, ConstInt(0)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_eq[8] += 1
                    return
            else:
                ...
                if arg_1_int_xor is not None:
                    ...
                    arg_1_1 = get_box_replacement(arg_1_int_xor.getarg(1))
                    b_arg_1_1 = self.getintbound(arg_1_1)
                    # eq_xor_cancel: int_eq(x, int_xor(x, y)) => int_eq(y, 0)
                    if self._eq(arg_1_0, b_arg_1_0, arg_0, b_arg_0):
                        newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_1, ConstInt(0)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_eq[11] += 1
                        return
                    # eq_xor_cancel: int_eq(x, int_xor(y, x)) => int_eq(y, 0)
                    if self._eq(arg_1_1, b_arg_1_1, arg_0, b_arg_0):
                        newop = self.replace_op_with(op, rop.INT_EQ, args=[arg_1_0, ConstInt(0)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_eq[11] += 1
                        return
        return self.emit(op)
    _rule_names_int_ne = ['ne_different_knownbits', 'ne_same', 'ne_zero', 'ne_add_sub_const_commute', 'ne_add_cancel_left', 'ne_sub_zero']
    _rule_fired_int_ne = [0] * 6
    ...
    def optimize_INT_NE(self, op):
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_sub is not None:
                ...
                arg_1_1 = get_box_replacement(arg_1_int_sub.getarg(1))
                b_arg_1_1 = self.getintbound(arg_1_1)
                # ne_sub_zero: int_ne(0, int_sub(x, y)) => int_ne(x, y)
                if C_arg_0 == 0:
                    newop = self.replace_op_with(op, rop.INT_NE, args=[arg_1_0, arg_1_1])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_ne[5] += 1
                    return
            else:
                arg_1_int_add = self.optimizer.as_operation(arg_1, rop.INT_ADD)
                if arg_1_int_add is not None:
                    ...
                    if b_arg_1_0.is_constant():
                        C_arg_1_0 = b_arg_1_0.get_constant_int()
                        # ne_add_sub_const_commute: int_ne(C2, int_add(C1, x)) => int_ne(x, C)
                        C = intmask(r_uint(C_arg_0) - r_uint(C_arg_1_0))
                        newop = self.replace_op_with(op, rop.INT_NE, args=[arg_1_1, ConstInt(C)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_ne[3] += 1
                        return
                    if b_arg_1_1.is_constant():
                        C_arg_1_1 = b_arg_1_1.get_constant_int()
                        # ne_add_sub_const_commute: int_ne(C2, int_add(x, C1)) => int_ne(x, C)
                        C = intmask(r_uint(C_arg_0) - r_uint(C_arg_1_1))
                        newop = self.replace_op_with(op, rop.INT_NE, args=[arg_1_0, ConstInt(C)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_ne[3] += 1
                        return
            ...
            if arg_0_int_sub is not None:
                ...
                if b_arg_1.is_constant():
                    C_arg_1 = b_arg_1.get_constant_int()
                    # ne_sub_zero: int_ne(int_sub(x, y), 0) => int_ne(x, y)
                    if C_arg_1 == 0:
                        newop = self.replace_op_with(op, rop.INT_NE, args=[arg_0_0, arg_0_1])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_ne[5] += 1
                        return
            else:
                ...
                if arg_0_int_add is not None:
                    ...
                    if b_arg_0_0.is_constant():
                        ...
                        if b_arg_1.is_constant():
                            C_arg_1 = b_arg_1.get_constant_int()
                            # ne_add_sub_const_commute: int_ne(int_add(C1, x), C2) => int_ne(x, C)
                            C = intmask(r_uint(C_arg_1) - r_uint(C_arg_0_0))
                            newop = self.replace_op_with(op, rop.INT_NE, args=[arg_0_1, ConstInt(C)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_ne[3] += 1
                            return
                    if b_arg_0_1.is_constant():
                        ...
                        if b_arg_1.is_constant():
                            C_arg_1 = b_arg_1.get_constant_int()
                            # ne_add_sub_const_commute: int_ne(int_add(x, C1), C2) => int_ne(x, C)
                            C = intmask(r_uint(C_arg_1) - r_uint(C_arg_0_1))
                            newop = self.replace_op_with(op, rop.INT_NE, args=[arg_0_0, ConstInt(C)])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_ne[3] += 1
                            return
                    # ne_add_cancel_left: int_ne(int_add(x, y), x) => int_ne(y, 0)
                    if self._eq(arg_1, b_arg_1, arg_0_0, b_arg_0_0):
                        newop = self.replace_op_with(op, rop.INT_NE, args=[arg_0_1, ConstInt(0)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_ne[4] += 1
                        return
                    # ne_add_cancel_left: int_ne(int_add(y, x), x) => int_ne(y, 0)
                    if self._eq(arg_1, b_arg_1, arg_0_1, b_arg_0_1):
                        newop = self.replace_op_with(op, rop.INT_NE, args=[arg_0_0, ConstInt(0)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_ne[4] += 1
                        return
        if b_arg_1.is_constant():
            ...
            if arg_1_int_add is not None:
                ...
                arg_1_1 = get_box_replacement(arg_1_int_add.getarg(1))
                b_arg_1_1 = self.getintbound(arg_1_1)
                # ne_add_cancel_left: int_ne(x, int_add(x, y)) => int_ne(y, 0)
                if self._eq(arg_1_0, b_arg_1_0, arg_0, b_arg_0):
                    newop = self.replace_op_with(op, rop.INT_NE, args=[arg_1_1, ConstInt(0)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_ne[4] += 1
                    return
                # ne_add_cancel_left: int_ne(x, int_add(y, x)) => int_ne(y, 0)
                if self._eq(arg_1_1, b_arg_1_1, arg_0, b_arg_0):
                    newop = self.replace_op_with(op, rop.INT_NE, args=[arg_1_0, ConstInt(0)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_ne[4] += 1
                    return
        return self.emit(op)
        ...
        if arg_0_int_and is not None:
            ...
            if b_arg_0_1.is_constant():
                ...
                if C_arg_0_1 == MININT:
                    ...
                    return
        return self.emit(op)
    _rule_names_int_is_zero = ['is_zero_true', 'is_zero_add']
    _rule_fired_int_is_zero = [0] * 2
    ...
    def optimize_INT_IS_ZERO(self, op):
        ...
        if arg_0_int_add is not None:
            ...
            if b_arg_0_0.is_constant():
                C_arg_0_0 = b_arg_0_0.get_constant_int()
                # is_zero_add: int_is_zero(int_add(C, x)) => 0
                if intmask(b_arg_0_1.lower) > intmask(-r_uint(C_arg_0_0)) or intmask(b_arg_0_1.upper) < intmask(-r_uint(C_arg_0_0)):
                    self.make_constant_int(op, 0)
                    self._rule_fired_int_is_zero[1] += 1
                    return
            if b_arg_0_1.is_constant():
                C_arg_0_1 = b_arg_0_1.get_constant_int()
                # is_zero_add: int_is_zero(int_add(x, C)) => 0
                if intmask(b_arg_0_0.lower) > intmask(-r_uint(C_arg_0_1)) or intmask(b_arg_0_0.upper) < intmask(-r_uint(C_arg_0_1)):
                    self.make_constant_int(op, 0)
                    self._rule_fired_int_is_zero[1] += 1
                    return
    ...
    def optimize_INT_FORCE_GE_ZERO(self, op):
        ...
        if b_arg_0.known_nonnegative():
            ...
            return
        return self.emit(op)
    _rule_names_int_invert = ['invert_invert', 'invert_neg']
    _rule_fired_int_invert = [0] * 2
    ...
    def optimize_INT_INVERT(self, op):
        ...
        if arg_0_int_neg is not None:
            arg_0_0 = get_box_replacement(arg_0_int_neg.getarg(0))
            b_arg_0_0 = self.getintbound(arg_0_0)
            # invert_neg: int_invert(int_neg(x)) => int_sub(x, 1)
            newop = self.replace_op_with(op, rop.INT_SUB, args=[arg_0_0, ConstInt(1)])
            self.optimizer.send_extra_operation(newop)
            self._rule_fired_int_invert[1] += 1
            return
        return self.emit(op)
    _rule_names_int_neg = ['neg_neg', 'neg_neg_sub']
    _rule_fired_int_neg = [0] * 2
    ...
    def optimize_INT_NEG(self, op):
        ...
        if arg_0_int_sub is not None:
            ...
            arg_0_1 = get_box_replacement(arg_0_int_sub.getarg(1))
            b_arg_0_1 = self.getintbound(arg_0_1)
            # neg_neg_sub: int_neg(int_sub(x, y)) => int_sub(y, x)
            newop = self.replace_op_with(op, rop.INT_SUB, args=[arg_0_1, arg_0_0])
            self.optimizer.send_extra_operation(newop)
            self._rule_fired_int_neg[1] += 1
            return
        return self.emit(op)
