...
class OptIntAutoGenerated(object):
                ...
                if b_arg_1_0.is_constant():
                    ...
                    if C_arg_1_0 == 1:
                        if b_arg_1_1.known_ge_const(0) and b_arg_1_1.known_le_const(LONG_BIT):
                            ...
                            return
        return self.emit(op)
    _rule_names_int_and = ['and_x_x', 'and_reassoc_consts', 'and_x_c_in_range', 'and_idempotent', 'and_or', 'and_known_result', 'and_absorb', 'and_signext']
    ...
    def optimize_INT_AND(self, op):
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_and is not None:
                ...
                arg_1_int_signext = self.optimizer.as_operation(arg_1, rop.INT_SIGNEXT)
                if arg_1_int_signext is not None:
                    arg_1_0 = get_box_replacement(arg_1_int_signext.getarg(0))
                    b_arg_1_0 = self.getintbound(arg_1_0)
                    arg_1_1 = get_box_replacement(arg_1_int_signext.getarg(1))
                    b_arg_1_1 = self.getintbound(arg_1_1)
                    if b_arg_1_1.is_constant():
                        C_arg_1_1 = b_arg_1_1.get_constant_int()
                        # and_signext: int_and(C1, int_signext(x, C2)) => int_and(x, C1)
                        if C_arg_0 == intmask(r_uint(1 << intmask(r_uint(C_arg_1_1) * r_uint(8))) - r_uint(1)):
                            newop = self.replace_op_with(op, rop.INT_AND, args=[arg_1_0, ConstInt(C_arg_0)])
                            self.optimizer.send_extra_operation(newop)
            ...
            if arg_0_int_and is not None:
                ...
                if arg_0_int_or is not None:
                    ...
                    arg_0_int_signext = self.optimizer.as_operation(arg_0, rop.INT_SIGNEXT)
                    if arg_0_int_signext is not None:
                        arg_0_0 = get_box_replacement(arg_0_int_signext.getarg(0))
                        b_arg_0_0 = self.getintbound(arg_0_0)
                        arg_0_1 = get_box_replacement(arg_0_int_signext.getarg(1))
                        b_arg_0_1 = self.getintbound(arg_0_1)
                        if b_arg_0_1.is_constant():
                            C_arg_0_1 = b_arg_0_1.get_constant_int()
                            if b_arg_1.is_constant():
                                C_arg_1 = b_arg_1.get_constant_int()
                                # and_signext: int_and(int_signext(x, C2), C1) => int_and(x, C1)
                                if C_arg_1 == intmask(r_uint(1 << intmask(r_uint(C_arg_0_1) * r_uint(8))) - r_uint(1)):
                                    newop = self.replace_op_with(op, rop.INT_AND, args=[arg_0_0, ConstInt(C_arg_1)])
                                    self.optimizer.send_extra_operation(newop)
                                    self._rule_fired_int_and[7] += 1
                                    return
        arg_1_int_and = self.optimizer.as_operation(arg_1, rop.INT_AND)
    ...
    def optimize_INT_NEG(self, op):
        ...
        if arg_0_int_neg is not None:
            ...
            return
        return self.emit(op)
    _rule_names_int_signext = ['signext_in_range', 'signext_and']
    _rule_fired_int_signext = [0] * 2
    _all_rules_fired.append(('int_signext', _rule_names_int_signext, _rule_fired_int_signext))
    def optimize_INT_SIGNEXT(self, op):
        ...
        if b_arg_1.is_constant():
            C_arg_1 = b_arg_1.get_constant_int()
            # signext_in_range: int_signext(x, C) => x
            if 0 < C_arg_1:
                if C_arg_1 < 100:
                    numbits = intmask(r_uint(C_arg_1) * r_uint(8))
                    if numbits <= LONG_BIT:
                        start = intmask(r_uint(0) - r_uint(1 << intmask(r_uint(numbits) - r_uint(1))))
                        stop = 1 << intmask(r_uint(numbits) - r_uint(1))
                        if b_arg_0.known_ge_const(start):
                            if b_arg_0.known_lt_const(stop):
                                self.make_equal_to(op, arg_0)
                                self._rule_fired_int_signext[0] += 1
                                return
        arg_0_int_and = self.optimizer.as_operation(arg_0, rop.INT_AND)
        if arg_0_int_and is not None:
            arg_0_0 = get_box_replacement(arg_0_int_and.getarg(0))
            ...
            if b_arg_0_0.is_constant():
                ...
                if b_arg_1.is_constant():
                    C_arg_1 = b_arg_1.get_constant_int()
                    # signext_and: int_signext(int_and(C1, x), C2) => int_signext(x, C2)
                    if C_arg_0_0 == intmask(r_uint(1 << intmask(r_uint(C_arg_1) * r_uint(8))) - r_uint(1)):
                        newop = self.replace_op_with(op, rop.INT_SIGNEXT, args=[arg_0_1, ConstInt(C_arg_1)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_signext[1] += 1
                        return
            if b_arg_0_1.is_constant():
                C_arg_0_1 = b_arg_0_1.get_constant_int()
                if b_arg_1.is_constant():
                    C_arg_1 = b_arg_1.get_constant_int()
                    # signext_and: int_signext(int_and(x, C1), C2) => int_signext(x, C2)
                    if C_arg_0_1 == intmask(r_uint(1 << intmask(r_uint(C_arg_1) * r_uint(8))) - r_uint(1)):
                        newop = self.replace_op_with(op, rop.INT_SIGNEXT, args=[arg_0_0, ConstInt(C_arg_1)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_signext[1] += 1
                        return
        return self.emit(op)
