...
class OptIntAutoGenerated(object):
    ...
    def optimize_INT_ADD(self, op):
        ...
        if arg_1_int_neg is not None:
            ...
            return
        return self.emit(op)
    _rule_names_int_sub = ['sub_zero', 'sub_const_canonicalize', 'sub_from_zero', 'sub_x_x', 'sub_add', 'sub_add_neg', 'sub_sub_right_c_c_x', 'sub_xor_x_y_y', 'sub_or_x_y_y', 'sub_invert_one', 'sub_neg']
            ...
            if b_arg_0_1.is_constant():
                ...
                if b_arg_1.is_constant():
                    ...
                    if C_arg_1 == C_arg_0_1:
                        ...
                        return
        return self.emit(op)
    _rule_names_int_eq = ['eq_different_knownbits', 'eq_same', 'eq_one', 'eq_zero', 'eq_sub_eq', 'add_const_eqv_cmp_shift', 'sub_compare_zero_eq_ne', 'bitxor_eq_zero', 'add_eq_self_iff_zero']
    _rule_fired_int_eq = [0] * 9
        ...
        if b_arg_1.is_constant():
            ...
            if arg_1_int_add is not None:
                ...
                if self._eq(arg_1_0, b_arg_1_0, arg_0, b_arg_0):
                    ...
                    return
        return self.emit(op)
    _rule_names_int_ne = ['ne_different_knownbits', 'ne_same', 'ne_zero', 'ne_add_sub_const_commute', 'ne_add_cancel_left']
    _rule_fired_int_ne = [0] * 5
