...
class OptIntAutoGenerated(object):
    def _eq(self, box1, bound1, box2, bound2):
        ...
        return False
    _all_rules_fired = []
    _rule_names_int_add = ['add_reassoc_consts', 'add_zero', 'add_sub_c_x_c', 'sub_add_cancel_right', 'add_neg_to_sub']
    _rule_fired_int_add = [0] * 5
    ...
    def optimize_INT_ADD(self, op):
        ...
        if arg_1_int_neg is not None:
            ...
            return
        return self.emit(op)
    _rule_names_int_sub = ['sub_zero', 'sub_const_canonicalize', 'sub_from_zero', 'sub_x_x', 'sub_add', 'sub_add_neg', 'sub_sub_right_c_c_x', 'sub_xor_x_y_y', 'sub_or_x_y_y', 'sub_invert_one', 'sub_neg', 'sub_add_add_cancel']
    _rule_fired_int_sub = [0] * 12
