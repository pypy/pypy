...
class OptIntAutoGenerated(object):
    ...
    def optimize_INT_NE(self, op):
        ...
        if b_arg_1.is_constant():
            ...
            if C_arg_1 == 0:
                ...
                return
        return self.emit(op)
    _rule_names_int_is_true = ['is_true_bool', 'is_true_true']
    _rule_fired_int_is_true = [0] * 2
    _all_rules_fired.append((_rule_names_int_is_true, _rule_fired_int_is_true))
    ...
    _all_rules_fired.append((_rule_names_int_is_zero, _rule_fired_int_is_zero))
