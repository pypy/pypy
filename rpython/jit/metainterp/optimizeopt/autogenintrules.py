...
class OptIntAutoGenerated(object):
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_add is not None:
                ...
                if b_arg_1_int_add_0.is_constant():
                    ...
                    return
        return self.emit(op)
    _rule_names_int_sub = ['sub_x_x', 'sub_zero', 'sub_add', 'sub_from_zero', 'sub_add_consts']
        ...
        if arg_0_int_add is not None:
            ...
            if b_arg_0_int_add_0.is_constant():
                ...
                if b_arg_1.is_constant():
                    ...
                    return
        return self.emit(op)
    _rule_names_int_mul = ['mul_zero', 'mul_one', 'mul_pow2_const', 'mul_lshift', 'mul_minus_one']
    ...
    def optimize_INT_MUL(self, op):
        ...
        if arg_1_int_lshift is not None:
            arg_1_int_lshift_0 = get_box_replacement(arg_1.getarg(0))
            b_arg_1_int_lshift_0 = self.getintbound(arg_1_int_lshift_0)
            arg_1_int_lshift_1 = get_box_replacement(arg_1.getarg(1))
            b_arg_1_int_lshift_1 = self.getintbound(arg_1_int_lshift_1)
            if b_arg_1_int_lshift_0.known_eq_const(1):
                if b_arg_1_int_lshift_1.known_ge_const(0) and b_arg_1_int_lshift_1.known_le_const(LONG_BIT):
                    newop = self.replace_op_with(op, rop.INT_LSHIFT, args=[arg_0, arg_1_int_lshift_1])
                    self.optimizer.send_extra_operation(newop)
        ...
        if arg_0_int_lshift is not None:
            arg_0_int_lshift_0 = get_box_replacement(arg_0.getarg(0))
            b_arg_0_int_lshift_0 = self.getintbound(arg_0_int_lshift_0)
            arg_0_int_lshift_1 = get_box_replacement(arg_0.getarg(1))
            b_arg_0_int_lshift_1 = self.getintbound(arg_0_int_lshift_1)
            if b_arg_0_int_lshift_0.known_eq_const(1):
                if b_arg_0_int_lshift_1.known_ge_const(0) and b_arg_0_int_lshift_1.known_le_const(LONG_BIT):
                    newop = self.replace_op_with(op, rop.INT_LSHIFT, args=[arg_1, arg_0_int_lshift_1])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_mul[3] += 1
                    return
        ...
        if b_arg_0.known_eq_const(-1):
            ...
            return
        return self.emit(op)
    _rule_names_int_and = ['and_zero', 'and_known_result', 'and_x_x', 'and_minus_1', 'and_x_c_in_range', 'and_x_y_covered_ones', 'and_reassoc_consts']
    ...
    def optimize_INT_AND(self, op):
        ...
        if arg_0_int_and is not None:
            arg_0_int_and_0 = get_box_replacement(arg_0.getarg(0))
            b_arg_0_int_and_0 = self.getintbound(arg_0_int_and_0)
            arg_0_int_and_1 = get_box_replacement(arg_0.getarg(1))
            b_arg_0_int_and_1 = self.getintbound(arg_0_int_and_1)
            if b_arg_0_int_and_1.is_constant():
                C_arg_0_int_and_1 = b_arg_0_int_and_1.get_constant_int()
                if b_arg_1.is_constant():
                    C_arg_1 = b_arg_1.get_constant_int()
                    C = C_arg_0_int_and_1 & C_arg_1
                    newop = self.replace_op_with(op, rop.INT_AND, args=[arg_0_int_and_0, ConstInt(C)])
                    self.optimizer.send_extra_operation(newop)
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_and is not None:
                arg_1_int_and_0 = get_box_replacement(arg_1.getarg(0))
                b_arg_1_int_and_0 = self.getintbound(arg_1_int_and_0)
                arg_1_int_and_1 = get_box_replacement(arg_1.getarg(1))
                b_arg_1_int_and_1 = self.getintbound(arg_1_int_and_1)
                if b_arg_1_int_and_1.is_constant():
                    C_arg_1_int_and_1 = b_arg_1_int_and_1.get_constant_int()
                    C = C_arg_1_int_and_1 & C_arg_0
                    newop = self.replace_op_with(op, rop.INT_AND, args=[arg_1_int_and_0, ConstInt(C)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_and[6] += 1
                    return
        ...
        if arg_0_int_and is not None:
            ...
            arg_0_int_and_1 = get_box_replacement(arg_0.getarg(1))
            b_arg_0_int_and_1 = self.getintbound(arg_0_int_and_1)
            if b_arg_0_int_and_0.is_constant():
                C_arg_0_int_and_0 = b_arg_0_int_and_0.get_constant_int()
                if b_arg_1.is_constant():
                    C_arg_1 = b_arg_1.get_constant_int()
                    C = C_arg_0_int_and_0 & C_arg_1
                    newop = self.replace_op_with(op, rop.INT_AND, args=[arg_0_int_and_1, ConstInt(C)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_and[6] += 1
                    return
        ...
        if b_arg_0.is_constant():
            ...
            if arg_1_int_and is not None:
                ...
                arg_1_int_and_1 = get_box_replacement(arg_1.getarg(1))
                b_arg_1_int_and_1 = self.getintbound(arg_1_int_and_1)
                if b_arg_1_int_and_0.is_constant():
                    C_arg_1_int_and_0 = b_arg_1_int_and_0.get_constant_int()
                    C = C_arg_1_int_and_0 & C_arg_0
                    newop = self.replace_op_with(op, rop.INT_AND, args=[arg_1_int_and_1, ConstInt(C)])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_and[6] += 1
                    return
        return self.emit(op)
    _rule_names_int_or = ['or_minus_1', 'or_known_result', 'or_x_x', 'or_zero']
    ...
    def optimize_INT_OR(self, op):
        ...
        if b_arg_0.known_eq_const(0):
            ...
            return
        return self.emit(op)
    _rule_names_int_xor = ['xor_x_x', 'xor_zero', 'xor_absorb', 'xor_minus_1']
    ...
    def optimize_INT_XOR(self, op):
        ...
        if arg_0_int_xor is not None:
            arg_0_int_xor_0 = get_box_replacement(arg_0.getarg(0))
            b_arg_0_int_xor_0 = self.getintbound(arg_0_int_xor_0)
            arg_0_int_xor_1 = get_box_replacement(arg_0.getarg(1))
            b_arg_0_int_xor_1 = self.getintbound(arg_0_int_xor_1)
            if arg_1 is arg_0_int_xor_1:
                self.make_equal_to(op, arg_0_int_xor_0)
        ...
        if arg_1_int_xor is not None:
            arg_1_int_xor_0 = get_box_replacement(arg_1.getarg(0))
            b_arg_1_int_xor_0 = self.getintbound(arg_1_int_xor_0)
            arg_1_int_xor_1 = get_box_replacement(arg_1.getarg(1))
            b_arg_1_int_xor_1 = self.getintbound(arg_1_int_xor_1)
            if arg_1_int_xor_1 is arg_0:
                self.make_equal_to(op, arg_1_int_xor_0)
                self._rule_fired_int_xor[2] += 1
                return
        ...
        if arg_0_int_xor is not None:
            ...
            arg_0_int_xor_1 = get_box_replacement(arg_0.getarg(1))
            b_arg_0_int_xor_1 = self.getintbound(arg_0_int_xor_1)
            if arg_1 is arg_0_int_xor_0:
                self.make_equal_to(op, arg_0_int_xor_1)
                self._rule_fired_int_xor[2] += 1
                return
        ...
        if arg_1_int_xor is not None:
            ...
            arg_1_int_xor_1 = get_box_replacement(arg_1.getarg(1))
            b_arg_1_int_xor_1 = self.getintbound(arg_1_int_xor_1)
            if arg_1_int_xor_0 is arg_0:
                self.make_equal_to(op, arg_1_int_xor_1)
                self._rule_fired_int_xor[2] += 1
                return
    ...
    def optimize_INT_LSHIFT(self, op):
        ...
        if arg_0_int_rshift is not None:
            arg_0_int_rshift_0 = get_box_replacement(arg_0.getarg(0))
            b_arg_0_int_rshift_0 = self.getintbound(arg_0_int_rshift_0)
            arg_0_int_rshift_1 = get_box_replacement(arg_0.getarg(1))
            b_arg_0_int_rshift_1 = self.getintbound(arg_0_int_rshift_1)
            if b_arg_0_int_rshift_1.is_constant():
                C_arg_0_int_rshift_1 = b_arg_0_int_rshift_1.get_constant_int()
                if b_arg_1.known_eq_const(C_arg_0_int_rshift_1):
                    if 0 <= C_arg_0_int_rshift_1 and C_arg_0_int_rshift_1 < LONG_BIT:
                        C = -1 >> C_arg_0_int_rshift_1 << C_arg_0_int_rshift_1
                        newop = self.replace_op_with(op, rop.INT_AND, args=[arg_0_int_rshift_0, ConstInt(C)])
                        self.optimizer.send_extra_operation(newop)
        ...
        if arg_0_uint_rshift is not None:
            arg_0_uint_rshift_0 = get_box_replacement(arg_0.getarg(0))
            b_arg_0_uint_rshift_0 = self.getintbound(arg_0_uint_rshift_0)
            arg_0_uint_rshift_1 = get_box_replacement(arg_0.getarg(1))
            b_arg_0_uint_rshift_1 = self.getintbound(arg_0_uint_rshift_1)
            if b_arg_0_uint_rshift_1.is_constant():
                C_arg_0_uint_rshift_1 = b_arg_0_uint_rshift_1.get_constant_int()
                if b_arg_1.known_eq_const(C_arg_0_uint_rshift_1):
                    if 0 <= C_arg_0_uint_rshift_1 and C_arg_0_uint_rshift_1 < LONG_BIT:
                        C = -1 >> C_arg_0_uint_rshift_1 << C_arg_0_uint_rshift_1
                        newop = self.replace_op_with(op, rop.INT_AND, args=[arg_0_uint_rshift_0, ConstInt(C)])
                        self.optimizer.send_extra_operation(newop)
                        self._rule_fired_int_lshift[3] += 1
                        return
        return self.emit(op)
    _rule_names_int_rshift = ['rshift_zero_x', 'rshift_known_result', 'rshift_x_zero']
    ...
    def optimize_INT_RSHIFT(self, op):
        ...
        if b_arg_1.known_eq_const(0):
            ...
            return
        return self.emit(op)
    _rule_names_uint_rshift = ['urshift_zero_x', 'urshift_known_result', 'urshift_x_zero', 'urshift_lshift_x_c_c']
    ...
    def optimize_UINT_RSHIFT(self, op):
        ...
        if arg_0_int_lshift is not None:
            ...
            arg_0_int_lshift_1 = get_box_replacement(arg_0.getarg(1))
            b_arg_0_int_lshift_1 = self.getintbound(arg_0_int_lshift_1)
            if b_arg_0_int_lshift_1.is_constant():
                C_arg_0_int_lshift_1 = b_arg_0_int_lshift_1.get_constant_int()
                if b_arg_1.known_eq_const(C_arg_0_int_lshift_1):
                    mask = intmask(r_uint(-1 << C_arg_0_int_lshift_1) >> r_uint(C_arg_0_int_lshift_1))
                    newop = self.replace_op_with(op, rop.INT_AND, args=[arg_0_int_lshift_0, ConstInt(mask)])
                    self.optimizer.send_extra_operation(newop)
    ...
    def optimize_INT_INVERT(self, op):
        ...
        if arg_0_int_invert is not None:
            arg_0_int_invert_0 = get_box_replacement(arg_0.getarg(0))
            b_arg_0_int_invert_0 = self.getintbound(arg_0_int_invert_0)
            self.make_equal_to(op, arg_0_int_invert_0)
    ...
    def optimize_INT_NEG(self, op):
        ...
        if arg_0_int_neg is not None:
            arg_0_int_neg_0 = get_box_replacement(arg_0.getarg(0))
            b_arg_0_int_neg_0 = self.getintbound(arg_0_int_neg_0)
            self.make_equal_to(op, arg_0_int_neg_0)
