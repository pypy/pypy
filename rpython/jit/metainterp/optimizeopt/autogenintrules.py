...
class OptIntAutoGenerated(object):
    def _eq(self, box1, bound1, box2, bound2):
        ...
        return False
    _all_rules_fired = []
    _rule_names_int_add = ['add_reassoc_consts', 'add_zero', 'add_sub_c_x_c', 'sub_add_cancel_right', 'add_neg_to_sub', 'add_invert_one']
    ...
    def optimize_INT_ADD(self, op):
        ...
        if b_arg_0.is_constant():
            C_arg_0 = b_arg_0.get_constant_int()
            arg_1_int_invert = self.optimizer.as_operation(arg_1, rop.INT_INVERT)
            if arg_1_int_invert is not None:
                arg_1_0 = get_box_replacement(arg_1_int_invert.getarg(0))
                b_arg_1_0 = self.getintbound(arg_1_0)
                # add_invert_one: int_add(1, int_invert(x)) => int_neg(x)
                if C_arg_0 == 1:
            ...
            if arg_0_int_invert is not None:
                ...
                if b_arg_1.is_constant():
                    C_arg_1 = b_arg_1.get_constant_int()
                    # add_invert_one: int_add(int_invert(x), 1) => int_neg(x)
                    if C_arg_1 == 1:
        ...
        if arg_1_int_neg is not None:
            ...
            return
        return self.emit(op)
    _rule_names_int_sub = ['sub_zero', 'sub_const_canonicalize', 'sub_from_zero', 'sub_x_x', 'sub_add', 'sub_add_neg', 'sub_sub_right_c_c_x', 'sub_xor_x_y_y', 'sub_or_x_y_y', 'sub_invert_one', 'sub_neg', 'sub_sub_cancel', 'sub_add_add_cancel']
    _rule_fired_int_sub = [0] * 13
            ...
            if arg_0_int_invert is not None:
                ...
                if arg_0_int_add is not None:
                    ...
                    if arg_0_int_sub is not None:
                        ...
                        arg_0_1 = get_box_replacement(arg_0_int_sub.getarg(1))
                        b_arg_0_1 = self.getintbound(arg_0_1)
                        # sub_sub_cancel: int_sub(int_sub(x, y), x) => int_neg(y)
                        if self._eq(arg_1, b_arg_1, arg_0_0, b_arg_0_0):
                            newop = self.replace_op_with(op, rop.INT_NEG, args=[arg_0_1])
                            self.optimizer.send_extra_operation(newop)
        ...
        if b_arg_1.is_constant():
            ...
            if arg_1_int_add is not None:
                ...
                if arg_1_int_neg is not None:
                    ...
                    return
        return self.emit(op)
    _rule_names_int_mul = ['mul_zero', 'mul_one', 'mul_minus_one', 'mul_pow2_const', 'mul_lshift', 'mul_neg_neg', 'mul_reassociate_const']
    _rule_fired_int_mul = [0] * 7
                ...
                if arg_0_int_mul is not None:
                    ...
                    if arg_0_int_neg is not None:
                        ...
                        if arg_1_int_neg is not None:
                            arg_1_0 = get_box_replacement(arg_1_int_neg.getarg(0))
                            b_arg_1_0 = self.getintbound(arg_1_0)
                            # mul_neg_neg: int_mul(int_neg(x), int_neg(y)) => int_mul(x, y)
                            newop = self.replace_op_with(op, rop.INT_MUL, args=[arg_0_0, arg_1_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_mul[5] += 1
                            return
                            # mul_neg_neg: int_mul(int_neg(y), int_neg(x)) => int_mul(x, y)
                            newop = self.replace_op_with(op, rop.INT_MUL, args=[arg_1_0, arg_0_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_mul[5] += 1
                            return
        if b_arg_1.is_constant():
        ...
        if arg_1_int_and is not None:
            ...
            if arg_1_int_or is not None:
                ...
                if b_arg_1_0.and_bound(b_arg_0).known_eq_const(0):
                    ...
                    return
        return self.emit(op)
    _rule_names_int_or = ['or_x_x', 'or_known_result', 'or_absorb', 'or_and_absorb', 'or_idempotent', 'or_and_two_parts', 'or_reassoc_consts', 'or_xor']
    _rule_fired_int_or = [0] * 8
    ...
    def optimize_INT_OR(self, op):
            ...
            if arg_0_int_and is not None:
                ...
                if arg_0_int_or is not None:
                    ...
                    if arg_0_int_xor is not None:
                        ...
                        arg_0_1 = get_box_replacement(arg_0_int_xor.getarg(1))
                        b_arg_0_1 = self.getintbound(arg_0_1)
                        # or_xor: int_or(int_xor(x, y), x) => int_or(x, y)
                        if self._eq(arg_1, b_arg_1, arg_0_0, b_arg_0_0):
                            newop = self.replace_op_with(op, rop.INT_OR, args=[arg_0_0, arg_0_1])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_or[7] += 1
                            return
                        # or_xor: int_or(int_xor(y, x), x) => int_or(x, y)
                        if self._eq(arg_1, b_arg_1, arg_0_1, b_arg_0_1):
                            newop = self.replace_op_with(op, rop.INT_OR, args=[arg_0_1, arg_0_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_or[7] += 1
        ...
        if arg_1_int_or is not None:
            ...
            if arg_1_int_xor is not None:
                ...
                b_arg_1_1 = self.getintbound(arg_1_1)
                # or_xor: int_or(x, int_xor(x, y)) => int_or(x, y)
                if self._eq(arg_1_0, b_arg_1_0, arg_0, b_arg_0):
                    newop = self.replace_op_with(op, rop.INT_OR, args=[arg_0, arg_1_1])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_or[7] += 1
                    return
                # or_xor: int_or(x, int_xor(y, x)) => int_or(x, y)
                if self._eq(arg_1_1, b_arg_1_1, arg_0, b_arg_0):
                    newop = self.replace_op_with(op, rop.INT_OR, args=[arg_0, arg_1_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_or[7] += 1
                    return
        return self.emit(op)
    _rule_names_int_xor = ['xor_x_x', 'xor_reassoc_consts', 'xor_absorb', 'xor_zero', 'xor_minus_1', 'xor_known_result', 'xor_is_not', 'xor_xor_xor_cancel', 'xor_invert_invert']
    _rule_fired_int_xor = [0] * 9
        ...
        if b_arg_0.is_constant():
            ...
            if arg_0_int_invert is not None:
                ...
                if arg_1_int_invert is not None:
                    arg_1_0 = get_box_replacement(arg_1_int_invert.getarg(0))
                    b_arg_1_0 = self.getintbound(arg_1_0)
                    # xor_invert_invert: int_xor(int_invert(x), int_invert(y)) => int_xor(x, y)
                    newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_0_0, arg_1_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_xor[8] += 1
                    return
                    # xor_invert_invert: int_xor(int_invert(y), int_invert(x)) => int_xor(x, y)
                    newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_1_0, arg_0_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_xor[8] += 1
                    return
            else:
                ...
                if arg_0_int_xor is not None:
                    ...
                    if arg_1_int_xor is not None:
                        ...
                        arg_1_1 = get_box_replacement(arg_1_int_xor.getarg(1))
                        b_arg_1_1 = self.getintbound(arg_1_1)
                        # xor_xor_xor_cancel: int_xor(int_xor(x, y), int_xor(x, z)) => int_xor(y, z)
                        if self._eq(arg_1_0, b_arg_1_0, arg_0_0, b_arg_0_0):
                            newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_0_1, arg_1_1])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_xor[7] += 1
                            return
                        # xor_xor_xor_cancel: int_xor(int_xor(x, z), int_xor(x, y)) => int_xor(y, z)
                        if self._eq(arg_1_0, b_arg_1_0, arg_0_0, b_arg_0_0):
                            newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_1_1, arg_0_1])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_xor[7] += 1
                            return
                        # xor_xor_xor_cancel: int_xor(int_xor(x, y), int_xor(z, x)) => int_xor(y, z)
                        if self._eq(arg_1_1, b_arg_1_1, arg_0_0, b_arg_0_0):
                            newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_0_1, arg_1_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_xor[7] += 1
                            return
                        # xor_xor_xor_cancel: int_xor(int_xor(z, x), int_xor(x, y)) => int_xor(y, z)
                        if self._eq(arg_1_0, b_arg_1_0, arg_0_1, b_arg_0_1):
                            newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_1_1, arg_0_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_xor[7] += 1
                            return
                        # xor_xor_xor_cancel: int_xor(int_xor(y, x), int_xor(x, z)) => int_xor(y, z)
                        if self._eq(arg_1_0, b_arg_1_0, arg_0_1, b_arg_0_1):
                            newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_0_0, arg_1_1])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_xor[7] += 1
                            return
                        # xor_xor_xor_cancel: int_xor(int_xor(x, z), int_xor(y, x)) => int_xor(y, z)
                        if self._eq(arg_1_1, b_arg_1_1, arg_0_0, b_arg_0_0):
                            newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_1_0, arg_0_1])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_xor[7] += 1
                            return
                        # xor_xor_xor_cancel: int_xor(int_xor(y, x), int_xor(z, x)) => int_xor(y, z)
                        if self._eq(arg_1_1, b_arg_1_1, arg_0_1, b_arg_0_1):
                            newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_0_0, arg_1_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_xor[7] += 1
                            return
                        # xor_xor_xor_cancel: int_xor(int_xor(z, x), int_xor(y, x)) => int_xor(y, z)
                        if self._eq(arg_1_1, b_arg_1_1, arg_0_1, b_arg_0_1):
                            newop = self.replace_op_with(op, rop.INT_XOR, args=[arg_1_0, arg_0_0])
                            self.optimizer.send_extra_operation(newop)
                            self._rule_fired_int_xor[7] += 1
            ...
            if b_arg_0_1.is_constant():
                ...
                if b_arg_1.is_constant():
                    ...
                    if C_arg_1 == C_arg_0_1:
                        ...
                        return
        return self.emit(op)
    _rule_names_int_eq = ['eq_different_knownbits', 'eq_same', 'eq_one', 'eq_zero', 'eq_sub_eq', 'add_const_eqv_cmp_shift', 'sub_compare_zero_eq_ne', 'bitxor_eq_zero', 'add_eq_self_iff_zero', 'eq_add_add_cancel']
    _rule_fired_int_eq = [0] * 10
    ...
    def optimize_INT_FORCE_GE_ZERO(self, op):
        ...
        if b_arg_0.known_nonnegative():
            ...
            return
        return self.emit(op)
    _rule_names_int_invert = ['invert_invert', 'invert_add_minus_one']
    ...
    def optimize_INT_INVERT(self, op):
        ...
        if arg_0_int_add is not None:
            ...
            if b_arg_0_0.is_constant():
                C_arg_0_0 = b_arg_0_0.get_constant_int()
                # invert_add_minus_one: int_invert(int_add(-1, x)) => int_neg(x)
                if C_arg_0_0 == -1:
                    newop = self.replace_op_with(op, rop.INT_NEG, args=[arg_0_1])
                    self.optimizer.send_extra_operation(newop)
            ...
            if b_arg_0_1.is_constant():
                C_arg_0_1 = b_arg_0_1.get_constant_int()
                # invert_add_minus_one: int_invert(int_add(x, -1)) => int_neg(x)
                if C_arg_0_1 == -1:
                    newop = self.replace_op_with(op, rop.INT_NEG, args=[arg_0_0])
                    self.optimizer.send_extra_operation(newop)
                    self._rule_fired_int_invert[1] += 1
