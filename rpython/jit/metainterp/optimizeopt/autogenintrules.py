            ...
            if arg_0_int_add is not None:
                ...
                if b_arg_0_1.is_constant():
                    ...
                    if b_arg_1.is_constant():
                        ...
                        return
        return self.emit(op)
    _rule_names_int_sub = ['sub_zero', 'sub_from_zero', 'sub_x_x', 'sub_add_consts', 'sub_add', 'sub_sub_x_c_c', 'sub_sub_c_x_c', 'xor_x_y_sub_y']
    _rule_fired_int_sub = [0] * 8
