...
class OptIntAutoGenerated(object):
    ...
    def optimize_INT_ADD(self, op):
        ...
        if arg_1_int_neg is not None:
            ...
            return
        return self.emit(op)
    _rule_names_int_sub = ['sub_zero', 'sub_const_canonicalize', 'sub_from_zero', 'sub_x_x', 'sub_add', 'sub_add_neg', 'sub_xor_x_y_y', 'sub_or_x_y_y', 'sub_invert_one']
    ...
    def optimize_INT_SUB(self, op):
        ...
        if b_arg_1.is_constant():
            ...
            C = intmask(r_uint(0) - r_uint(C_arg_1))
