...
class ResOpAssembler(BaseAssembler):
    ...
    emit_op_jit_emit_ret = emit_op_debug_merge_point
    emit_op_jit_emit_jump = emit_op_debug_merge_point
    emit_op_begin_slow_path = emit_op_debug_merge_point
    emit_op_end_slow_path = emit_op_debug_merge_point
