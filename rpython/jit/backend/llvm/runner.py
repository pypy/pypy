...
class LLVM_CPU(AbstractLLCPU):
    ...
    def setup_once(self):
        ...
        self.Module = self.CreateModule("hot_code")
    ...
    def initialise_api(self):
        ...
        self.AddIncoming = rffi.llexternal("LLVMAddIncoming", [self.ValueRef, lltype.Ptr(self.ValueRef), self.BasicBlockRef, lltype.Unsigned], self.Void, compilation_info=info)
