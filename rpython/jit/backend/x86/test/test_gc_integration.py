...
from rpython.jit.backend.llsupport.descr import FieldDescr, FLAG_SIGNED
...
from rpython.jit.backend.x86.test.test_regalloc import MockAssembler
from rpython.jit.backend.x86.test.test_regalloc import BaseTestRegalloc
from rpython.jit.backend.x86.regalloc import X86RegisterManager, X86FrameManager,\
