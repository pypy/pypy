...
class BaseTests(RandomLoopBase):
    ...
    def test_failure2(self):
        self.check('{{d2-Bab-D48<(e3-E0d+Eac-B1d>(9b>(25>(14+Da9-Eb9-B{05=n(x)bb+Cb2+Ee6+C}35-Acd+E)(c4-Exaa-A{ce=n(x)}0c+E)7e<(0b-B85-Dc9-Bb2-Dcc<(x11+A9a+Cx)(xxde+Da8+B)6b-Ada-D)aa+D))73+D{dc=n(x)d9-Bea+A8e=(81<(e8-D)(94+B8c+D9d-E{ee=n(x)a0+Dx43-Bx}a0+B56+Ca7-C4e=(01-C4c+Dxa7-B))3a-Cae-B50+Cb3-Aee+D4b-Bb5+B)}ed+Ea6>(ab+Abb-C86+B{b9<n(x){db>n(x){b1>n(x)21+C}3e=(db+Excd-Dx21+C)48-B}{6a<n(x)ce+D1d+C{2d<n(x)c0-A96+Be3-E5d-B2d-E}55-D9c<(x3b-Ceb-A98+Abc-A)()ee+Cca+E{de<n(x)3c+Dxx7d-Bcd-Cd1-D}{ea<n(x)29+Cb8-C6a+Dda-A3b-A96+B9e+Cdb-Cx}}xe7>(x{0b<n(x)28+Ex0c-Dcb-Bxbd-B96+D})4a-C56+C6c+B}x))6a-E6e+E}}', [49, 58, 34, 95, 30], 1000)
