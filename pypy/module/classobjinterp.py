...
def lookup(space, w_cls, w_attr):
    ...
    while True:
        ...
        if goto is glabel_10:
            w_34 = space.newtuple([w_v_3, w_found_1])
            w_7 = w_34
            goto = glabel_12

        if goto is glabel_11:
            raise OperationError(w_etype, w_evalue)

        if goto is glabel_12:
            return w_7
...
def __new__(space, w_subtype, w_name, w_bases, w_dic):
    ...
    while True:
        ...
        if goto is glabel_32:
            raise OperationError(w_etype, w_evalue)

        if goto is glabel_33:
            return w_79
...
##SECTION##
# global declarations
# global object glabel_19
# global object gs___class__
# global object glabel_18
# global object glabel_16
# global object glabel_14
# global object glabel_15
# global object gs__s_instance_has_no_attribute__s
# global object glabel_17
