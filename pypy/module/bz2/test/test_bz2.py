...
class AppTestBZ2Decompressor:
    ...
    def test_decompress_unused_data(self):
        ...
        decompressed_data = bz2d.decompress(DATA + unused_data)
        assert decompressed_data == TEXT
...
def test_decompress_function_incomplete_data():
    ...
    raises(ValueError, decompress, DATA[:-10])
