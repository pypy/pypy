...
class TestMicroNumPy(BaseTestPyPyC):
    ...
    def test_array_flatiter_getitem_single(self):
        ...
        assert loop.match("""
            ...
            p150 = getfield_gc_pure(p123, descr=<FieldP pypy.module.micronumpy.iterators.IterState.inst__indices .+>)
            i151 = int_add(i117, 1)
            ...
            setfield_gc(p156, p150, descr=<FieldP pypy.module.micronumpy.iterators.IterState.inst__indices .+>)
    ...
    def test_array_flatiter_setitem_single(self):
        ...
        assert loop.match("""
            ...
            p152 = getfield_gc_pure(p126, descr=<FieldP pypy.module.micronumpy.iterators.IterState.inst__indices .+>)
            i153 = int_add(i120, 1)
            i154 = getfield_raw(#, descr=<FieldS pypysig_long_struct.c_value 0>)
            ...
            setfield_gc(p158, p152, descr=<FieldP pypy.module.micronumpy.iterators.IterState.inst__indices .+>)
