...
@cpython_api([], rffi.CWCHARP, error=CANNOT_FAIL, abi3=True)
...
@cpython_api([], rffi.CCHARP, abi3=True)
...
@cpython_api([lltype.Ptr(lltype.FuncType([], lltype.Void))], rffi.INT_real, error=-1, abi3=True)
...
@cpython_api([], lltype.Void, error=CANNOT_FAIL, abi3=True)
