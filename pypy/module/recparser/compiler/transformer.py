...
PYTHON_23 = sys.version_info[0]==2 and sys.version_info[1]==3
PYTHON_24 = sys.version_info[0]==2 and sys.version_info[1]==4
...
##      elseNode.lineno = nodelist[-1][1][2]
    ...
    def com_assign(self, node, assigning):
        ...
        while 1:
            t = node[0]
            if t == symbol.exprlist or t == symbol.testlist or (PYTHON_24 and t == symbol.testlist_gexp):
                if len(node) > 2:
