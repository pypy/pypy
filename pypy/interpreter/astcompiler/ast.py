...
def FunctionDef_get_returns(space, w_self):
    ...
    if not w_self.initialization_state & 64:
        raise operationerrfmt(space.w_AttributeError, "'%T' object has no attribute '%s'", w_self, 'returns')
...
def Raise_get_exc(space, w_self):
    if w_self.w_dict is not None:
        ...
        if w_obj is not None:
            return w_obj
    if not w_self.initialization_state & 4:
        raise operationerrfmt(space.w_AttributeError, "'%T' object has no attribute '%s'", w_self, 'exc')
...
def Raise_get_cause(space, w_self):
    if w_self.w_dict is not None:
        ...
        if w_obj is not None:
            return w_obj
    if not w_self.initialization_state & 8:
        raise operationerrfmt(space.w_AttributeError, "'%T' object has no attribute '%s'", w_self, 'cause')
...
def arguments_get_varargannotation(space, w_self):
    if w_self.w_dict is not None:
        ...
        if w_obj is not None:
            return w_obj
    if not w_self.initialization_state & 4:
        raise operationerrfmt(space.w_AttributeError, "'%T' object has no attribute '%s'", w_self, 'varargannotation')
...
def arguments_get_kwonlyargs(space, w_self):
    if not w_self.initialization_state & 8:
        raise operationerrfmt(space.w_AttributeError, "'%T' object has no attribute '%s'", w_self, 'kwonlyargs')
...
def arguments_get_kwargannotation(space, w_self):
    if w_self.w_dict is not None:
        ...
        if w_obj is not None:
            return w_obj
    if not w_self.initialization_state & 32:
        raise operationerrfmt(space.w_AttributeError, "'%T' object has no attribute '%s'", w_self, 'kwargannotation')
...
def arguments_get_kw_defaults(space, w_self):
    if not w_self.initialization_state & 128:
        raise operationerrfmt(space.w_AttributeError, "'%T' object has no attribute '%s'", w_self, 'kw_defaults')
...
def arg_get_annotation(space, w_self):
    if w_self.w_dict is not None:
        ...
        if w_obj is not None:
            return w_obj
    if not w_self.initialization_state & 2:
        raise operationerrfmt(space.w_AttributeError, "'%T' object has no attribute '%s'", w_self, 'annotation')
