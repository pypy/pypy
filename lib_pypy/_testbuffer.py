...
try:
    ...
    modfile = '_testbuffer' + _pypy_testcapi._get_c_extension_suffix()
    spec = spec_from_file_location('_testbuffer',
    ...
    try:
        ...
        if os.name == 'nt':
            ...
            try:
                ...
                pass
        mod = _pypy_testcapi.compile_shared(cfile, '_testbuffer', thisdir)
