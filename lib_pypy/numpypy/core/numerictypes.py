######################################################################
# This is a copy of numpy/core/numerictypes.py modified for numpypy
######################################################################
"""
...
from .multiarray import (
        typeinfo, ndarray, array, empty, dtype,
        )
...
if sys.version_info[0] >= 3:
    _toadd = ['int', 'float', 'complex', 'bool',
              'str', 'bytes', ('a', allTypes['bytes_'])]
else:
